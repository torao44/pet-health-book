 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(D,z){var B=D.length;D.push(z);e:for(;0<B;){var ae=B-1>>>1,me=D[ae];if(0<i(me,z))D[ae]=z,D[B]=me,B=ae;else break e}}function n(D){return D.length===0?null:D[0]}function r(D){if(D.length===0)return null;var z=D[0],B=D.pop();if(B!==z){D[0]=B;e:for(var ae=0,me=D.length,mr=me>>>1;ae<mr;){var be=2*(ae+1)-1,ze=D[be],Pt=be+1,Bn=D[Pt];if(0>i(ze,B))Pt<me&&0>i(Bn,ze)?(D[ae]=Bn,D[Pt]=B,ae=Pt):(D[ae]=ze,D[be]=B,ae=be);else if(Pt<me&&0>i(Bn,B))D[ae]=Bn,D[Pt]=B,ae=Pt;else break e}}return z}function i(D,z){var B=D.sortIndex-z.sortIndex;return B!==0?B:D.id-z.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,l=o.now();t.unstable_now=function(){return o.now()-l}}var a=[],u=[],f=1,h=null,d=3,m=!1,y=!1,w=!1,I=typeof setTimeout=="function"?setTimeout:null,g=typeof clearTimeout=="function"?clearTimeout:null,p=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function _(D){for(var z=n(u);z!==null;){if(z.callback===null)r(u);else if(z.startTime<=D)r(u),z.sortIndex=z.expirationTime,e(a,z);else break;z=n(u)}}function S(D){if(w=!1,_(D),!y)if(n(a)!==null)y=!0,pt(P);else{var z=n(u);z!==null&&mi(S,z.startTime-D)}}function P(D,z){y=!1,w&&(w=!1,g(x),x=-1),m=!0;var B=d;try{for(_(z),h=n(a);h!==null&&(!(h.expirationTime>z)||D&&!N());){var ae=h.callback;if(typeof ae=="function"){h.callback=null,d=h.priorityLevel;var me=ae(h.expirationTime<=z);z=t.unstable_now(),typeof me=="function"?h.callback=me:h===n(a)&&r(a),_(z)}else r(a);h=n(a)}if(h!==null)var mr=!0;else{var be=n(u);be!==null&&mi(S,be.startTime-z),mr=!1}return mr}finally{h=null,d=B,m=!1}}var A=!1,R=null,x=-1,F=5,j=-1;function N(){return!(t.unstable_now()-j<F)}function Q(){if(R!==null){var D=t.unstable_now();j=D;var z=!0;try{z=R(!0,D)}finally{z?Se():(A=!1,R=null)}}else A=!1}var Se;if(typeof p=="function")Se=function(){p(Q)};else if(typeof MessageChannel<"u"){var ye=new MessageChannel,zn=ye.port2;ye.port1.onmessage=Q,Se=function(){zn.postMessage(null)}}else Se=function(){I(Q,0)};function pt(D){R=D,A||(A=!0,Se())}function mi(D,z){x=I(function(){D(t.unstable_now())},z)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(D){D.callback=null},t.unstable_continueExecution=function(){y||m||(y=!0,pt(P))},t.unstable_forceFrameRate=function(D){0>D||125<D?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):F=0<D?Math.floor(1e3/D):5},t.unstable_getCurrentPriorityLevel=function(){return d},t.unstable_getFirstCallbackNode=function(){return n(a)},t.unstable_next=function(D){switch(d){case 1:case 2:case 3:var z=3;break;default:z=d}var B=d;d=z;try{return D()}finally{d=B}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(D,z){switch(D){case 1:case 2:case 3:case 4:case 5:break;default:D=3}var B=d;d=D;try{return z()}finally{d=B}},t.unstable_scheduleCallback=function(D,z,B){var ae=t.unstable_now();switch(typeof B=="object"&&B!==null?(B=B.delay,B=typeof B=="number"&&0<B?ae+B:ae):B=ae,D){case 1:var me=-1;break;case 2:me=250;break;case 5:me=1073741823;break;case 4:me=1e4;break;default:me=5e3}return me=B+me,D={id:f++,callback:z,priorityLevel:D,startTime:B,expirationTime:me,sortIndex:-1},B>ae?(D.sortIndex=B,e(u,D),n(a)===null&&D===n(u)&&(w?(g(x),x=-1):w=!0,mi(S,B-ae))):(D.sortIndex=me,e(a,D),y||m||(y=!0,pt(P))),D},t.unstable_shouldYield=N,t.unstable_wrapCallback=function(D){var z=d;return function(){var B=d;d=z;try{return D.apply(this,arguments)}finally{d=B}}}})(Ip);kp.exports=Ip;var cv=kp.exports;/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const k=function(t,e){if(!t)throw ui(e)},ui=function(t){return new Error("Firebase Database ("+km.SDK_VERSION+") INTERNAL ASSERT FAILED: "+t)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ou="[DEFAULT]",LC={[bu]:"fire-core",[uC]:"fire-core-compat",[dC]:"fire-analytics",[cC]:"fire-analytics-compat",[fC]:"fire-app-check",[hC]:"fire-app-check-compat",[pC]:"fire-auth",[gC]:"fire-auth-compat",[mC]:"fire-rtdb",[_C]:"fire-data-connect",[yC]:"fire-rtdb-compat",[vC]:"fire-fn",[wC]:"fire-fn-compat",[CC]:"fire-iid",[SC]:"fire-iid-compat",[EC]:"fire-fcm",[xC]:"fire-fcm-compat",[kC]:"fire-perf",[IC]:"fire-perf-compat",[TC]:"fire-rc",[AC]:"fire-rc-compat",[RC]:"fire-gcs",[PC]:"fire-gcs-compat",[NC]:"fire-fst",[bC]:"fire-fst-compat",[DC]:"fire-vertex","fire-js":"fire-js",[OC]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zo extends c_{static getInstance(){return new Zo}constructor(){super(["online"]),this.online_=!0,typeof window<"u"&&typeof window.addEventListener<"u"&&!Kc()&&(window.addEventListener("online",()=>{this.online_||(this.online_=!0,this.trigger("online",!0))},!1),window.addEventListener("offline",()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))},!1))}getInitialEvent(e){return k(e==="online","Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ju;function XS(t){ju=t}const m_=function(t){return typeof t=="number"?"number:"+Gm(t):"string:"+t},__=function(t){if(t.isLeafNode()){const e=t.val();k(typeof e=="string"||typeof e=="number"||typeof e=="object"&&rn(e,".sv"),"Priority must be a string or number.")}else k(t===ju||t.isEmpty(),"priority of unexpected type.");k(t===ju||t.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let If;class Ee{static set __childrenNodeConstructor(e){If=e}static get __childrenNodeConstructor(){return If}constructor(e,n=Ee.__childrenNodeConstructor.EMPTY_NODE){this.value_=e,this.priorityNode_=n,this.lazyHash_=null,k(this.value_!==void 0&&this.value_!==null,"LeafNode shouldn't be created with null/undefined value."),__(this.priorityNode_)}isLeafNode(){return!0}getPriority(){return this.priorityNode_}updatePriority(e){return new Ee(this.value_,e)}getImmediateChild(e){return e===".priority"?this.priorityNode_:Ee.__childrenNodeConstructor.EMPTY_NODE}getChild(e){return G(e)?this:H(e)===".priority"?this.priorityNode_:Ee.__childrenNodeConstructor.EMPTY_NODE}hasChild(){return!1}getPredecessorChildName(e,n){return null}updateImmediateChild(e,n){return e===".priority"?this.updatePriority(n):n.isEmpty()&&e!==".priority"?this:Ee.__childrenNodeConstructor.EMPTY_NODE.updateImmediateChild(e,n).updatePriority(this.priorityNode_)}updateChild(e,n){const r=H(e);return r===null?n:n.isEmpty()&&r!==".priority"?this:(k(r!==".priority"||Dn(e)===1,".priority must be the last token in a path"),this.updateImmediateChild(r,Ee.__childrenNodeConstructor.EMPTY_NODE.updateChild(ne(e),n)))}isEmpty(){return!1}numChildren(){return 0}forEachChild(e,n){return!1}val(e){return e&&!this.getPriority().isEmpty()?{".value":this.getValue(),".priority":this.getPriority().val()}:this.getValue()}hash(){if(this.lazyHash_===null){let e="";this.priorityNode_.isEmpty()||(e+="priority:"+m_(this.priorityNode_.val())+":");const n=typeof this.value_;e+=n+":",n==="number"?e+=Gm(this.value_):e+=this.value_,this.lazyHash_=Hm(e)}return this.lazyHash_}getValue(){return this.value_}compareTo(e){return e===Ee.__childrenNodeConstructor.EMPTY_NODE?1:e instanceof Ee.__childrenNodeConstructor?-1:(k(e.isLeafNode(),"Unknown node type"),this.compareToLeafNode_(e))}compareToLeafNode_(e){const n=typeof e.value_,r=typeof this.value_,i=Ee.VALUE_TYPE_ORDER.indexOf(n),s=Ee.VALUE_TYPE_ORDER.indexOf(r);return k(i>=0,"Unknown leaf type: "+n),k(s>=0,"Unknown leaf type: "+r),i===s?r==="object"?0:this.value_<e.value_?-1:this.value_===e.value_?0:1:s-i}withIndex(){return this}isIndexed(){return!0}equals(e){if(e===this)return!0;if(e.isLeafNode()){const n=e;return this.value_===n.value_&&this.priorityNode_.equals(n.priorityNode_)}else return!1}}Ee.VALUE_TYPE_ORDER=["object","boolean","number","string"];/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tE=Math.log(2);class nE{constructor(e){const n=s=>parseInt(Math.log(s)/tE,10),r=s=>parseInt(Array(s+1).join("1"),2);this.count=n(e+1),this.current_=this.count-1;const i=r(this.count);this.bits_=e+1&i}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const el=function(t,e,n,r){t.sort(e);const i=function(a,u){const f=u-a;let h,d;if(f===0)return null;if(f===1)return h=t[a],d=n?n(h):h,new ke(d,h.node,ke.BLACK,null,null);{const m=parseInt(f/2,10)+a,y=i(a,m),w=i(m+1,u);return h=t[m],d=n?n(h):h,new ke(d,h.node,ke.BLACK,y,w)}},s=function(a){let u=null,f=null,h=t.length;const d=function(y,w){const I=h-y,g=h;h-=y;const p=i(I+1,g),_=t[I],S=n?n(_):_;m(new ke(S,_.node,w,null,p))},m=function(y){u?(u.left=y,u=y):(f=y,u=y)};for(let y=0;y<a.count;++y){const w=a.nextBitIsOne(),I=Math.pow(2,a.count-(y+1));w?d(I,ke.BLACK):(d(I,ke.BLACK),d(I,ke.RED))}return f},o=new nE(t.length),l=s(o);return new Qe(r||e,l)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ta;const yr={};class Ht{static get Default(){return k(yr&&pe,"ChildrenNode.ts has not been loaded"),Ta=Ta||new Ht({".priority":yr},{".priority":pe}),Ta}constructor(e,n){this.indexes_=e,this.indexSet_=n}get(e){const n=ei(this.indexes_,e);if(!n)throw new Error("No index defined for "+e);return n instanceof Qe?n:null}hasIndex(e){return rn(this.indexSet_,e.toString())}addIndex(e,n){k(e!==Wr,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const r=[];let i=!1;const s=n.getIterator($.Wrap);let o=s.getNext();for(;o;)i=i||e.isDefinedOn(o.node),r.push(o),o=s.getNext();let l;i?l=el(r,e.getCompare()):l=yr;const a=e.toString(),u={...this.indexSet_};u[a]=e;const f={...this.indexes_};return f[a]=l,new Ht(f,u)}addToIndexes(e,n){const r=qo(this.indexes_,(i,s)=>{const o=ei(this.indexSet_,s);if(k(o,"Missing index implementation for "+s),i===yr)if(o.isDefinedOn(e.node)){const l=[],a=n.getIterator($.Wrap);let u=a.getNext();for(;u;)u.name!==e.name&&l.push(u),u=a.getNext();return l.push(e),el(l,o.getCompare())}else return yr;else{const l=n.get(e.name);let a=i;return l&&(a=a.remove(new $(e.name,l))),a.insert(e,e.node)}});return new Ht(r,this.indexSet_)}removeFromIndexes(e,n){const r=qo(this.indexes_,i=>{if(i===yr)return i;{const s=n.get(e.name);return s?i.remove(new $(e.name,s)):i}});return new Ht(r,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class od{constructor(){this.limitSet_=!1,this.startSet_=!1,this.startNameSet_=!1,this.startAfterSet_=!1,this.endSet_=!1,this.endNameSet_=!1,this.endBeforeSet_=!1,this.limit_=0,this.viewFrom_="",this.indexStartValue_=null,this.indexStartName_="",this.indexEndValue_=null,this.indexEndName_="",this.index_=pe}hasStart(){return this.startSet_}isViewFromLeft(){return this.viewFrom_===""?this.startSet_:this.viewFrom_==="l"}getIndexStartValue(){return k(this.startSet_,"Only valid if start has been set"),this.indexStartValue_}getIndexStartName(){return k(this.startSet_,"Only valid if start has been set"),this.startNameSet_?this.indexStartName_:ni}hasEnd(){return this.endSet_}getIndexEndValue(){return k(this.endSet_,"Only valid if end has been set"),this.indexEndValue_}getIndexEndName(){return k(this.endSet_,"Only valid if end has been set"),this.endNameSet_?this.indexEndName_:ar}hasLimit(){return this.limitSet_}hasAnchoredLimit(){return this.limitSet_&&this.viewFrom_!==""}getLimit(){return k(this.limitSet_,"Only valid if limit has been set"),this.limit_}getIndex(){return this.index_}loadsAllData(){return!(this.startSet_||this.endSet_||this.limitSet_)}isDefault(){return this.loadsAllData()&&this.index_===pe}copy(){const e=new od;return e.limitSet_=this.limitSet_,e.limit_=this.limit_,e.startSet_=this.startSet_,e.startAfterSet_=this.startAfterSet_,e.indexStartValue_=this.indexStartValue_,e.startNameSet_=this.startNameSet_,e.indexStartName_=this.indexStartName_,e.endSet_=this.endSet_,e.endBeforeSet_=this.endBeforeSet_,e.indexEndValue_=this.indexEndValue_,e.endNameSet_=this.endNameSet_,e.indexEndName_=this.indexEndName_,e.index_=this.index_,e.viewFrom_=this.viewFrom_,e}}function cE(t){return t.loadsAllData()?new sd(t.getIndex()):t.hasLimit()?new uE(t):new _s(t)}function Tf(t){const e={};if(t.isDefault())return e;let n;if(t.index_===pe?n="$priority":t.index_===lE?n="$value":t.index_===Wr?n="$key":(k(t.index_ instanceof sE,"Unrecognized index type!"),n=t.index_.toString()),e.orderBy=Ie(n),t.startSet_){const r=t.startAfterSet_?"startAfter":"startAt";e[r]=Ie(t.indexStartValue_),t.startNameSet_&&(e[r]+=","+Ie(t.indexStartName_))}if(t.endSet_){const r=t.endBeforeSet_?"endBefore":"endAt";e[r]=Ie(t.indexEndValue_),t.endNameSet_&&(e[r]+=","+Ie(t.indexEndName_))}return t.limitSet_&&(t.isViewFromLeft()?e.limitToFirst=t.limit_:e.limitToLast=t.limit_),e}function Af(t){const e={};if(t.startSet_&&(e.sp=t.indexStartValue_,t.startNameSet_&&(e.sn=t.indexStartName_),e.sin=!t.startAfterSet_),t.endSet_&&(e.ep=t.indexEndValue_,t.endNameSet_&&(e.en=t.indexEndName_),e.ein=!t.endBeforeSet_),t.limitSet_){e.l=t.limit_;let n=t.viewFrom_;n===""&&(t.isViewFromLeft()?n="l":n="r"),e.vf=n}return t.index_!==pe&&(e.i=t.index_.toString()),e}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rl{constructor(e,n,r){this.path=e,this.affectedTree=n,this.revert=r,this.type=Et.ACK_USER_WRITE,this.source=S_()}operationForChild(e){if(G(this.path)){if(this.affectedTree.value!=null)return k(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const n=this.affectedTree.subtree(new te(e));return new rl(X(),n,this.revert)}}else return k(H(this.path)===e,"operationForChild called for unrelated child."),new rl(ne(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vs{constructor(e,n,r){this.source=e,this.path=n,this.children=r,this.type=Et.MERGE}operationForChild(e){if(G(this.path)){const n=this.children.subtree(new te(e));return n.isEmpty()?null:n.value?new ur(this.source,X(),n.value):new vs(this.source,X(),n)}else return k(H(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new vs(this.source,ne(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class FE{constructor(){this.changeMap=new Map}trackChildChange(e){const n=e.type,r=e.childName;k(n==="child_added"||n==="child_changed"||n==="child_removed","Only child changes supported for tracking"),k(r!==".priority","Only non-priority child changes can be tracked.");const i=this.changeMap.get(r);if(i){const s=i.type;if(n==="child_added"&&s==="child_removed")this.changeMap.set(r,ms(r,e.snapshotNode,i.snapshotNode));else if(n==="child_removed"&&s==="child_added")this.changeMap.delete(r);else if(n==="child_removed"&&s==="child_changed")this.changeMap.set(r,gs(r,i.oldSnap));else if(n==="child_changed"&&s==="child_added")this.changeMap.set(r,ri(r,e.snapshotNode));else if(n==="child_changed"&&s==="child_changed")this.changeMap.set(r,ms(r,e.snapshotNode,i.oldSnap));else throw ui("Illegal combination of changes: "+e+" occurred after "+i)}else this.changeMap.set(r,e)}getChanges(){return Array.from(this.changeMap.values())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ME(t){return{filter:t}}function jE(t,e){k(e.eventCache.getNode().isIndexed(t.filter.getIndex()),"Event snap not indexed"),k(e.serverCache.getNode().isIndexed(t.filter.getIndex()),"Server snap not indexed")}function zE(t,e,n,r,i){const s=new FE;let o,l;if(n.type===Et.OVERWRITE){const u=n;u.source.fromUser?o=Hu(t,e,u.path,u.snap,r,i,s):(k(u.source.fromServer,"Unknown source."),l=u.source.tagged||e.serverCache.isFiltered()&&!G(u.path),o=ol(t,e,u.path,u.snap,r,i,l,s))}else if(n.type===Et.MERGE){const u=n;u.source.fromUser?o=UE(t,e,u.path,u.children,r,i,s):(k(u.source.fromServer,"Unknown source."),l=u.source.tagged||e.serverCache.isFiltered(),o=$u(t,e,u.path,u.children,r,i,l,s))}else if(n.type===Et.ACK_USER_WRITE){const u=n;u.revert?o=$E(t,e,u.path,r,i,s):o=WE(t,e,u.path,u.affectedTree,r,i,s)}else if(n.type===Et.LISTEN_COMPLETE)o=HE(t,e,n.path,r,s);else throw ui("Unknown operation type: "+n.type);const a=s.getChanges();return BE(e,o,a),{viewCache:o,changes:a}}function BE(t,e,n){const r=e.eventCache;if(r.isFullyInitialized()){const i=r.getNode().isLeafNode()||r.getNode().isEmpty(),s=Bu(t);(n.length>0||!t.eventCache.isFullyInitialized()||i&&!r.getNode().equals(s)||!r.getNode().getPriority().equals(s.getPriority()))&&n.push(w_(Bu(e)))}}function P_(t,e,n,r,i,s){const o=e.eventCache;if(sl(r,n)!=null)return e;{let l,a;if(G(n))if(k(e.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),e.serverCache.isFiltered()){const u=dr(e),f=u instanceof L?u:L.EMPTY_NODE,h=cd(r,f);l=t.filter.updateFullNode(e.eventCache.getNode(),h,s)}else{const u=il(r,dr(e));l=t.filter.updateFullNode(e.eventCache.getNode(),u,s)}else{const u=H(n);if(u===".priority"){k(Dn(n)===1,"Can't have a priority with additional path components");const f=o.getNode();a=e.serverCache.getNode();const h=bf(r,n,f,a);h!=null?l=t.filter.updatePriority(f,h):l=o.getNode()}else{const f=ne(n);let h;if(o.isCompleteForChild(u)){a=e.serverCache.getNode();const d=bf(r,n,o.getNode(),a);d!=null?h=o.getNode().getImmediateChild(u).updateChild(f,d):h=o.getNode().getImmediateChild(u)}else h=dd(r,u,e.serverCache);h!=null?l=t.filter.updateChild(o.getNode(),u,h,f,i,s):l=o.getNode()}}return Vi(e,l,o.isFullyInitialized()||G(n),t.filter.filtersNodes())}}function ol(t,e,n,r,i,s,o,l){const a=e.serverCache;let u;const f=o?t.filter:t.filter.getIndexedFilter();if(G(n))u=f.updateFullNode(a.getNode(),r,null);else if(f.filtersNodes()&&!a.isFiltered()){const m=a.getNode().updateChild(n,r);u=f.updateFullNode(a.getNode(),m,null)}else{const m=H(n);if(!a.isCompleteForPath(n)&&Dn(n)>1)return e;const y=ne(n),I=a.getNode().getImmediateChild(m).updateChild(y,r);m===".priority"?u=f.updatePriority(a.getNode(),I):u=f.updateChild(a.getNode(),m,I,y,R_,null)}const h=E_(e,u,a.isFullyInitialized()||G(n),f.filtersNodes()),d=new hd(i,h,s);return P_(t,h,n,i,d,l)}function Hu(t,e,n,r,i,s,o){const l=e.eventCache;let a,u;const f=new hd(i,e,s);if(G(n))u=t.filter.updateFullNode(e.eventCache.getNode(),r,o),a=Vi(e,u,!0,t.filter.filtersNodes());else{const h=H(n);if(h===".priority")u=t.filter.updatePriority(e.eventCache.getNode(),r),a=Vi(e,u,l.isFullyInitialized(),l.isFiltered());else{const d=ne(n),m=l.getNode().getImmediateChild(h);let y;if(G(d))y=r;else{const w=f.getCompleteChild(h);w!=null?d_(d)===".priority"&&w.getChild(f_(d)).isEmpty()?y=w:y=w.updateChild(d,r):y=L.EMPTY_NODE}if(m.equals(y))a=e;else{const w=t.filter.updateChild(l.getNode(),h,y,d,f,o);a=Vi(e,w,l.isFullyInitialized(),t.filter.filtersNodes())}}}return a}function Of(t,e){return t.eventCache.isCompleteForChild(e)}function UE(t,e,n,r,i,s,o){let l=e;return r.foreach((a,u)=>{const f=we(n,a);Of(e,H(f))&&(l=Hu(t,l,f,u,i,s,o))}),r.foreach((a,u)=>{const f=we(n,a);Of(e,H(f))||(l=Hu(t,l,f,u,i,s,o))}),l}function Ff(t,e,n){return n.foreach((r,i)=>{e=e.updateChild(r,i)}),e}function $u(t,e,n,r,i,s,o,l){if(e.serverCache.getNode().isEmpty()&&!e.serverCache.isFullyInitialized())return e;let a=e,u;G(n)?u=r:u=new se(null).setTree(n,r);const f=e.serverCache.getNode();return u.children.inorderTraversal((h,d)=>{if(f.hasChild(h)){const m=e.serverCache.getNode().getImmediateChild(h),y=Ff(t,m,d);a=ol(t,a,new te(h),y,i,s,o,l)}}),u.children.inorderTraversal((h,d)=>{const m=!e.serverCache.isCompleteForChild(h)&&d.value===null;if(!f.hasChild(h)&&!m){const y=e.serverCache.getNode().getImmediateChild(h),w=Ff(t,y,d);a=ol(t,a,new te(h),w,i,s,o,l)}}),a}function WE(t,e,n,r,i,s,o){if(sl(i,n)!=null)return e;const l=e.serverCache.isFiltered(),a=e.serverCache;if(r.value!=null){if(G(n)&&a.isFullyInitialized()||a.isCompleteForPath(n))return ol(t,e,n,a.getNode().getChild(n),i,s,l,o);if(G(n)){let u=new se(null);return a.getNode().forEachChild(Wr,(f,h)=>{u=u.set(new te(f),h)}),$u(t,e,n,u,i,s,l,o)}else return e}else{let u=new se(null);return r.foreach((f,h)=>{const d=we(n,f);a.isCompleteForPath(d)&&(u=u.set(f,a.getNode().getChild(d)))}),$u(t,e,n,u,i,s,l,o)}}function HE(t,e,n,r,i){const s=e.serverCache,o=E_(e,s.getNode(),s.isFullyInitialized()||G(n),s.isFiltered());return P_(t,o,n,r,R_,i)}function $E(t,e,n,r,i,s){let o;if(sl(r,n)!=null)return e;{const l=new hd(r,e,i),a=e.eventCache.getNode();let u;if(G(n)||H(n)===".priority"){let f;if(e.serverCache.isFullyInitialized())f=il(r,dr(e));else{const h=e.serverCache.getNode();k(h instanceof L,"serverChildren would be complete if leaf node"),f=cd(r,h)}f=f,u=t.filter.updateFullNode(a,f,s)}else{const f=H(n);let h=dd(r,f,e.serverCache);h==null&&e.serverCache.isCompleteForChild(f)&&(h=a.getImmediateChild(f)),h!=null?u=t.filter.updateChild(a,f,h,ne(n),l,s):e.eventCache.getNode().hasChild(f)?u=t.filter.updateChild(a,f,L.EMPTY_NODE,ne(n),l,s):u=a,u.isEmpty()&&e.serverCache.isFullyInitialized()&&(o=il(r,dr(e)),o.isLeafNode()&&(u=t.filter.updateFullNode(u,o,s)))}return o=e.serverCache.isFullyInitialized()||sl(r,X())!=null,Vi(e,u,o,t.filter.filtersNodes())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ll;class qE{constructor(){this.views=new Map}}function XE(t){k(!ll,"__referenceConstructor has already been defined"),ll=t}function JE(){return k(ll,"Reference.ts has not been loaded"),ll}function ZE(t){return t.views.size===0}function fd(t,e,n,r){const i=e.source.queryId;if(i!==null){const s=t.views.get(i);return k(s!=null,"SyncTree gave us an op for an invalid query."),jf(s,e,n,r)}else{let s=[];for(const o of t.views.values())s=s.concat(jf(o,e,n,r));return s}}function ex(t,e,n,r,i){const s=e._queryIdentifier,o=t.views.get(s);if(!o){let l=il(n,i?r:null),a=!1;l?a=!0:r instanceof L?(l=cd(n,r),a=!1):(l=L.EMPTY_NODE,a=!1);const u=Ll(new cr(l,a,!1),new cr(r,i,!1));return new VE(e,u)}return o}function tx(t,e,n,r,i,s){const o=ex(t,e,r,i,s);return t.views.has(e._queryIdentifier)||t.views.set(e._queryIdentifier,o),QE(o,n),YE(o,n)}function nx(t,e,n,r){const i=e._queryIdentifier,s=[];let o=[];const l=bn(t);if(i==="default")for(const[a,u]of t.views.entries())o=o.concat(Mf(u,n,r)),Lf(u)&&(t.views.delete(a),u.query._queryParams.loadsAllData()||s.push(u.query));else{const a=t.views.get(i);a&&(o=o.concat(Mf(a,n,r)),Lf(a)&&(t.views.delete(i),a.query._queryParams.loadsAllData()||s.push(a.query)))}return l&&!bn(t)&&s.push(new(JE())(e._repo,e._path)),{removed:s,events:o}}function D_(t){const e=[];for(const n of t.views.values())n.query._queryParams.loadsAllData()||e.push(n);return e}function Hr(t,e){let n=null;for(const r of t.views.values())n=n||KE(r,e);return n}function b_(t,e){if(e._queryParams.loadsAllData())return Ml(t);{const r=e._queryIdentifier;return t.views.get(r)}}function O_(t,e){return b_(t,e)!=null}function bn(t){return Ml(t)!=null}function Ml(t){for(const e of t.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let al;function rx(t){k(!al,"__referenceConstructor has already been defined"),al=t}function ix(){return k(al,"Reference.ts has not been loaded"),al}let sx=1;class zf{constructor(e){this.listenProvider_=e,this.syncPointTree_=new se(null),this.pendingWriteTree_=bE(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function F_(t,e,n,r,i){return SE(t.pendingWriteTree_,e,n,r,i),i?Ns(t,new ur(S_(),e,n)):[]}function qn(t,e,n=!1){const r=EE(t.pendingWriteTree_,e);if(xE(t.pendingWriteTree_,e)){let s=new se(null);return r.snap!=null?s=s.set(X(),!0):Ze(r.children,o=>{s=s.set(new te(o),!0)}),Ns(t,new rl(r.path,s,n))}else return[]}function jl(t,e,n){return Ns(t,new ur(ld(),e,n))}function ox(t,e,n){const r=se.fromObject(n);return Ns(t,new vs(ld(),e,r))}function lx(t,e){return Ns(t,new ys(ld(),e))}function ax(t,e,n){const r=gd(t,n);if(r){const i=md(r),s=i.path,o=i.queryId,l=Ke(s,e),a=new ys(ad(o),l);return _d(t,s,a)}else return[]}function Vu(t,e,n,r,i=!1){const s=e._path,o=t.syncPointTree_.get(s);let l=[];if(o&&(e._queryIdentifier==="default"||O_(o,e))){const a=nx(o,e,n,r);ZE(o)&&(t.syncPointTree_=t.syncPointTree_.remove(s));const u=a.removed;if(l=a.events,!i){const f=u.findIndex(d=>d._queryParams.loadsAllData())!==-1,h=t.syncPointTree_.findOnPath(s,(d,m)=>bn(m));if(f&&!h){const d=t.syncPointTree_.subtree(s);if(!d.isEmpty()){const m=dx(d);for(let y=0;y<m.length;++y){const w=m[y],I=w.query,g=j_(t,w);t.listenProvider_.startListening(Ki(I),ul(t,I),g.hashFn,g.onComplete)}}}!h&&u.length>0&&!r&&(f?t.listenProvider_.stopListening(Ki(e),null):u.forEach(d=>{const m=t.queryToTagMap.get(zl(d));t.listenProvider_.stopListening(Ki(d),m)}))}hx(t,u)}return l}function ux(t,e,n,r){const i=gd(t,r);if(i!=null){const s=md(i),o=s.path,l=s.queryId,a=Ke(o,e),u=new ur(ad(l),a,n);return _d(t,o,u)}else return[]}function cx(t,e,n,r){const i=gd(t,r);if(i){const s=md(i),o=s.path,l=s.queryId,a=Ke(o,e),u=se.fromObject(n),f=new vs(ad(l),a,u);return _d(t,o,f)}else return[]}function Bf(t,e,n,r=!1){const i=e._path;let s=null,o=!1;t.syncPointTree_.foreachOnPath(i,(d,m)=>{const y=Ke(d,i);s=s||Hr(m,y),o=o||bn(m)});let l=t.syncPointTree_.get(i);l?(o=o||bn(l),s=s||Hr(l,X())):(l=new qE,t.syncPointTree_=t.syncPointTree_.set(i,l));let a;s!=null?a=!0:(a=!1,s=L.EMPTY_NODE,t.syncPointTree_.subtree(i).foreachChild((m,y)=>{const w=Hr(y,X());w&&(s=s.updateImmediateChild(m,w))}));const u=O_(l,e);if(!u&&!e._queryParams.loadsAllData()){const d=zl(e);k(!t.queryToTagMap.has(d),"View does not exist, but we have a tag");const m=fx();t.queryToTagMap.set(d,m),t.tagToQueryMap.set(m,d)}const f=ud(t.pendingWriteTree_,i);let h=tx(l,e,n,f,s,a);if(!u&&!o&&!r){const d=b_(l,e);h=h.concat(px(t,e,d))}return h}function pd(t,e,n){const i=t.pendingWriteTree_,s=t.syncPointTree_.findOnPath(e,(o,l)=>{const a=Ke(o,e),u=Hr(l,a);if(u)return u});return I_(i,e,s,n,!0)}function Ns(t,e){return L_(e,t.syncPointTree_,null,ud(t.pendingWriteTree_,X()))}function L_(t,e,n,r){if(G(t.path))return M_(t,e,n,r);{const i=e.get(X());n==null&&i!=null&&(n=Hr(i,X()));let s=[];const o=H(t.path),l=t.operationForChild(o),a=e.children.get(o);if(a&&l){const u=n?n.getImmediateChild(o):null,f=T_(r,o);s=s.concat(L_(l,a,u,f))}return i&&(s=s.concat(fd(i,t,r,n))),s}}function M_(t,e,n,r){const i=e.get(X());n==null&&i!=null&&(n=Hr(i,X()));let s=[];return e.children.inorderTraversal((o,l)=>{const a=n?n.getImmediateChild(o):null,u=T_(r,o),f=t.operationForChild(o);f&&(s=s.concat(M_(f,l,a,u)))}),i&&(s=s.concat(fd(i,t,r,n))),s}function j_(t,e){const n=e.query,r=ul(t,n);return{hashFn:()=>(GE(e)||L.EMPTY_NODE).hash(),onComplete:i=>{if(i==="ok")return r?ax(t,n._path,r):lx(t,n._path);{const s=uS(i,n);return Vu(t,n,null,s)}}}}function ul(t,e){const n=zl(e);return t.queryToTagMap.get(n)}function zl(t){return t._path.toString()+"$"+t._queryIdentifier}function gd(t,e){return t.tagToQueryMap.get(e)}function md(t){const e=t.indexOf("$");return k(e!==-1&&e<t.length-1,"Bad queryKey."),{queryId:t.substr(e+1),path:new te(t.substr(0,e))}}function _d(t,e,n){const r=t.syncPointTree_.get(e);k(r,"Missing sync point for query tag that we're tracking");const i=ud(t.pendingWriteTree_,e);return fd(r,n,i,null)}function dx(t){return t.fold((e,n,r)=>{if(n&&bn(n))return[Ml(n)];{let i=[];return n&&(i=D_(n)),Ze(r,(s,o)=>{i=i.concat(o)}),i}})}function Ki(t){return t._queryParams.loadsAllData()&&!t._queryParams.isDefault()?new(ix())(t._repo,t._path):t}function hx(t,e){for(let n=0;n<e.length;++n){const r=e[n];if(!r._queryParams.loadsAllData()){const i=zl(r),s=t.queryToTagMap.get(i);t.queryToTagMap.delete(i),t.tagToQueryMap.delete(s)}}}function fx(){return sx++}function px(t,e,n){const r=e._path,i=ul(t,e),s=j_(t,n),o=t.listenProvider_.startListening(Ki(e),i,s.hashFn,s.onComplete),l=t.syncPointTree_.subtree(r);if(i)k(!bn(l.value),"If we're adding a query, it shouldn't be shadowed");else{const a=l.fold((u,f,h)=>{if(!G(u)&&f&&bn(f))return[Ml(f).query];{let d=[];return f&&(d=d.concat(D_(f).map(m=>m.query))),Ze(h,(m,y)=>{d=d.concat(y)}),d}});for(let u=0;u<a.length;++u){const f=a[u];t.listenProvider_.stopListening(Ki(f),ul(t,f))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Nx="repo_interrupt",Dx=25;class bx{constructor(e,n,r,i){this.repoInfo_=e,this.forceRestClient_=n,this.authTokenProvider_=r,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new Rx,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=nl(),this.transactionQueueTree_=new Cd,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function Ox(t,e,n){if(t.stats_=ed(t.repoInfo_),t.forceRestClient_||fS())t.server_=new tl(t.repoInfo_,(r,i,s,o)=>{Wf(t,r,i,s,o)},t.authTokenProvider_,t.appCheckProvider_),setTimeout(()=>Hf(t,!0),0);else{if(typeof n<"u"&&n!==null){if(typeof n!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{Ie(n)}catch(r){throw new Error("Invalid authOverride provided: "+r)}}t.persistentConnection_=new Kt(t.repoInfo_,e,(r,i,s,o)=>{Wf(t,r,i,s,o)},r=>{Hf(t,r)},r=>{Lx(t,r)},t.authTokenProvider_,t.appCheckProvider_,n),t.server_=t.persistentConnection_}t.authTokenProvider_.addTokenChangeListener(r=>{t.server_.refreshAuthToken(r)}),t.appCheckProvider_.addTokenChangeListener(r=>{t.server_.refreshAppCheckToken(r.token)}),t.statsReporter_=yS(t.repoInfo_,()=>new mE(t.stats_,t.server_)),t.infoData_=new dE,t.infoSyncTree_=new zf({startListening:(r,i,s,o)=>{let l=[];const a=t.infoData_.getNode(r._path);return a.isEmpty()||(l=jl(t.infoSyncTree_,r._path,a),setTimeout(()=>{o("ok")},0)),l},stopListening:()=>{}}),Id(t,"connected",!1),t.serverSyncTree_=new zf({startListening:(r,i,s,o)=>(t.server_.listen(r,s,i,(l,a)=>{const u=o(l,a);en(t.eventQueue_,r._path,u)}),[]),stopListening:(r,i)=>{t.server_.unlisten(r,i)}})}function Fx(t){const n=t.infoData_.getNode(new te(".info/serverTimeOffset")).val()||0;return new Date().getTime()+n}function kd(t){return gx({timestamp:Fx(t)})}function Wf(t,e,n,r,i){t.dataUpdateCount++;const s=new te(e);n=t.interceptServerDataCallback_?t.interceptServerDataCallback_(e,n):n;let o=[];if(i)if(r){const a=qo(n,u=>Pe(u));o=cx(t.serverSyncTree_,s,a,i)}else{const a=Pe(n);o=ux(t.serverSyncTree_,s,a,i)}else if(r){const a=qo(n,u=>Pe(u));o=ox(t.serverSyncTree_,s,a)}else{const a=Pe(n);o=jl(t.serverSyncTree_,s,a)}let l=s;o.length>0&&(l=Ul(t,s)),en(t.eventQueue_,l,o)}function Hf(t,e){Id(t,"connected",e),e===!1&&jx(t)}function Lx(t,e){Ze(e,(n,r)=>{Id(t,n,r)})}function Id(t,e,n){const r=new te("/.info/"+e),i=Pe(n);t.infoData_.updateSnapshot(r,i);const s=jl(t.infoSyncTree_,r,i);en(t.eventQueue_,r,s)}function Q_(t){return t.nextWriteId_++}function Mx(t,e,n,r,i){Td(t,"set",{path:e.toString(),value:n,priority:r});const s=kd(t),o=Pe(n,r),l=pd(t.serverSyncTree_,e),a=z_(o,l,s),u=Q_(t),f=F_(t.serverSyncTree_,e,a,u,!0);xd(t.eventQueue_,f),t.server_.put(e.toString(),o.val(!0),(d,m)=>{const y=d==="ok";y||Je("set at "+e+" failed: "+d);const w=qn(t.serverSyncTree_,u,!y);en(t.eventQueue_,e,w),Ux(t,i,d,m)});const h=Z_(t,e);Ul(t,h),en(t.eventQueue_,h,[])}function jx(t){Td(t,"onDisconnectEvents");const e=kd(t),n=nl();zu(t.onDisconnect_,X(),(i,s)=>{const o=yx(i,s,t.serverSyncTree_,e);C_(n,i,o)});let r=[];zu(n,X(),(i,s)=>{r=r.concat(jl(t.serverSyncTree_,i,s));const o=Z_(t,i);Ul(t,o)}),t.onDisconnect_=nl(),en(t.eventQueue_,X(),r)}function zx(t,e,n){let r;H(e._path)===".info"?r=Bf(t.infoSyncTree_,e,n):r=Bf(t.serverSyncTree_,e,n),G_(t.eventQueue_,e._path,r)}function $f(t,e,n){let r;H(e._path)===".info"?r=Vu(t.infoSyncTree_,e,n):r=Vu(t.serverSyncTree_,e,n),G_(t.eventQueue_,e._path,r)}function Bx(t){t.persistentConnection_&&t.persistentConnection_.interrupt(Nx)}function Td(t,...e){let n="";t.persistentConnection_&&(n=t.persistentConnection_.id+":"),Me(n,...e)}function Ux(t,e,n,r){e&&fi(()=>{if(n==="ok")e(null);else{const i=(n||"error").toUpperCase();let s=i;r&&(s+=": "+r);const o=new Error(s);o.code=i,e(o)}})}function Y_(t,e,n){return pd(t.serverSyncTree_,e,n)||L.EMPTY_NODE}function Ad(t,e=t.transactionQueueTree_){if(e||Wl(t,e),pi(e)){const n=X_(t,e);k(n.length>0,"Sending zero length transaction queue"),n.every(i=>i.status===0)&&Wx(t,Ds(e),n)}else U_(e)&&Bl(e,n=>{Ad(t,n)})}function Wx(t,e,n){const r=n.map(u=>u.currentWriteId),i=Y_(t,e,r);let s=i;const o=i.hash();for(let u=0;u<n.length;u++){const f=n[u];k(f.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),f.status=1,f.retryCount++;const h=Ke(e,f.path);s=s.updateChild(h,f.currentOutputSnapshotRaw)}const l=s.val(!0),a=e;t.server_.put(a.toString(),l,u=>{Td(t,"transaction put response",{path:a.toString(),status:u});let f=[];if(u==="ok"){const h=[];for(let d=0;d<n.length;d++)n[d].status=2,f=f.concat(qn(t.serverSyncTree_,n[d].currentWriteId)),n[d].onComplete&&h.push(()=>n[d].onComplete(null,!0,n[d].currentOutputSnapshotResolved)),n[d].unwatcher();Wl(t,Sd(t.transactionQueueTree_,e)),Ad(t,t.transactionQueueTree_),en(t.eventQueue_,e,f);for(let d=0;d<h.length;d++)fi(h[d])}else{if(u==="datastale")for(let h=0;h<n.length;h++)n[h].status===3?n[h].status=4:n[h].status=0;else{Je("transaction at "+a.toString()+" failed: "+u);for(let h=0;h<n.length;h++)n[h].status=4,n[h].abortReason=u}Ul(t,e)}},o)}function Ul(t,e){const n=q_(t,e),r=Ds(n),i=X_(t,n);return Hx(t,i,r),r}function Hx(t,e,n){if(e.length===0)return;const r=[];let i=[];const o=e.filter(l=>l.status===0).map(l=>l.currentWriteId);for(let l=0;l<e.length;l++){const a=e[l],u=Ke(n,a.path);let f=!1,h;if(k(u!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),a.status===4)f=!0,h=a.abortReason,i=i.concat(qn(t.serverSyncTree_,a.currentWriteId,!0));else if(a.status===0)if(a.retryCount>=Dx)f=!0,h="maxretry",i=i.concat(qn(t.serverSyncTree_,a.currentWriteId,!0));else{const d=Y_(t,a.path,o);a.currentInputSnapshot=d;const m=e[l].update(d.val());if(m!==void 0){Ed("transaction failed: Data returned ",m,a.path);let y=Pe(m);typeof m=="object"&&m!=null&&rn(m,".priority")||(y=y.updatePriority(d.getPriority()));const I=a.currentWriteId,g=kd(t),p=z_(y,d,g);a.currentOutputSnapshotRaw=y,a.currentOutputSnapshotResolved=p,a.currentWriteId=Q_(t),o.splice(o.indexOf(I),1),i=i.concat(F_(t.serverSyncTree_,a.path,p,a.currentWriteId,a.applyLocally)),i=i.concat(qn(t.serverSyncTree_,I,!0))}else f=!0,h="nodata",i=i.concat(qn(t.serverSyncTree_,a.currentWriteId,!0))}en(t.eventQueue_,n,i),i=[],f&&(e[l].status=2,function(d){setTimeout(d,Math.floor(0))}(e[l].unwatcher),e[l].onComplete&&(h==="nodata"?r.push(()=>e[l].onComplete(null,!1,e[l].currentInputSnapshot)):r.push(()=>e[l].onComplete(new Error(h),!1,null))))}Wl(t,t.transactionQueueTree_);for(let l=0;l<r.length;l++)fi(r[l]);Ad(t,t.transactionQueueTree_)}function q_(t,e){let n,r=t.transactionQueueTree_;for(n=H(e);n!==null&&pi(r)===void 0;)r=Sd(r,n),e=ne(e),n=H(e);return r}function X_(t,e){const n=[];return J_(t,e,n),n.sort((r,i)=>r.order-i.order),n}function J_(t,e,n){const r=pi(e);if(r)for(let i=0;i<r.length;i++)n.push(r[i]);Bl(e,i=>{J_(t,i,n)})}function Wl(t,e){const n=pi(e);if(n){let r=0;for(let i=0;i<n.length;i++)n[i].status!==2&&(n[r]=n[i],r++);n.length=r,B_(e,n.length>0?n:void 0)}Bl(e,r=>{Wl(t,r)})}function Z_(t,e){const n=Ds(q_(t,e)),r=Sd(t.transactionQueueTree_,e);return wx(r,i=>{Pa(t,i)}),Pa(t,r),W_(r,i=>{Pa(t,i)}),n}function Pa(t,e){const n=pi(e);if(n){const r=[];let i=[],s=-1;for(let o=0;o<n.length;o++)n[o].status===3||(n[o].status===1?(k(s===o-1,"All SENT items should be at beginning of queue."),s=o,n[o].status=3,n[o].abortReason="set"):(k(n[o].status===0,"Unexpected transaction status in abort"),n[o].unwatcher(),i=i.concat(qn(t.serverSyncTree_,n[o].currentWriteId,!0)),n[o].onComplete&&r.push(n[o].onComplete.bind(null,new Error("set"),!1,null))));s===-1?B_(e,void 0):n.length=s+1,en(t.eventQueue_,Ds(e),i);for(let o=0;o<r.length;o++)fi(r[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rd{constructor(e,n,r,i){this._repo=e,this._path=n,this._queryParams=r,this._orderByCalled=i}get key(){return G(this._path)?null:d_(this._path)}get ref(){return new jn(this._repo,this._path)}get _queryIdentifier(){const e=Af(this._queryParams),n=Jc(e);return n==="{}"?"default":n}get _queryObject(){return Af(this._queryParams)}isEqual(e){if(e=ot(e),!(e instanceof Rd))return!1;const n=this._repo===e._repo,r=nd(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return n&&r&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+US(this._path)}}class jn extends Rd{constructor(e,n){super(e,n,new od,!1)}get parent(){const e=f_(this._path);return e===null?null:new jn(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class cl{constructor(e,n,r){this._node=e,this.ref=n,this._index=r}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const n=new te(e),r=Ku(this.ref,e);return new cl(this._node.getChild(n),r,pe)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(r,i)=>e(new cl(i,Ku(this.ref,r),pe)))}hasChild(e){const n=new te(e);return!this._node.getChild(n).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function on(t,e){return t=ot(t),t._checkNotDeleted("ref"),e!==void 0?Ku(t._root,e):t._root}function Ku(t,e){return t=ot(t),H(t._path)===null?Ix("child","path",e):V_("child","path",e),new jn(t._repo,we(t._path,e))}function vr(t,e){t=ot(t),Tx("set",t._path),kx("set",e,t._path);const n=new bl;return Mx(t._repo,t._path,e,null,n.wrapCallback(()=>{})),n.promise}class Pd{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,n){const r=n._queryParams.getIndex();return new Kx("value",this,new cl(e.snapshotNode,new jn(n._repo,n._path),r))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new Qx(this,e,n):null}matches(e){return e instanceof Pd?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function qx(t,e,n,r,i){let s;if(typeof r=="object"&&(s=void 0,i=r),typeof r=="function"&&(s=r),i&&i.onlyOnce){const a=n,u=(f,h)=>{$f(t._repo,t,l),a(f,h)};u.userCallback=n.userCallback,u.context=n.context,n=u}const o=new Yx(n,s||void 0),l=new Pd(o);return zx(t._repo,t,l),()=>$f(t._repo,t,l)}function Na(t,e,n,r){return qx(t,"value",e,n,r)}XE(jn);rx(jn);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Kk="__/auth/handler",Qk="emulator/auth/handler",Yk=encodeURIComponent("fac");async function op(t,e,n,r,i,s){M(t.config.authDomain,t,"auth-domain-config-required"),M(t.config.apiKey,t,"invalid-api-key");const o={apiKey:t.config.apiKey,appName:t.name,authType:n,redirectUrl:r,v:di,eventId:i};if(e instanceof jd){e.setDefaultLanguage(t.languageCode),o.providerId=e.providerId||"",Pu(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[f,h]of Object.entries({}))o[f]=h}if(e instanceof Os){const f=e.getScopes().filter(h=>h!=="");f.length>0&&(o.scopes=f.join(","))}t.tenantId&&(o.tid=t.tenantId);const l=o;for(const f of Object.keys(l))l[f]===void 0&&delete l[f];const a=await t._getAppCheckToken(),u=a?`#${Yk}=${encodeURIComponent(a)}`:"";return`${qk(t)}?${ci(l).slice(1)}${u}`}function qk({config:t}){return t.emulator?bd(t,Qk):`https://${t.authDomain}/${Kk}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ba="webStorageSupport";class Xk{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=Sy,this._completeRedirectFn=Ck,this._overrideRedirectResult=yk}async _openPopup(e,n,r,i){var o;tn((o=this.eventManagers[e._key()])==null?void 0:o.manager,"_initialize() not called before _openPopup()");const s=await op(e,n,r,Yu(),i);return Vk(e,s,zd())}async _openRedirect(e,n,r,i){await this._originValidation(e);const s=await op(e,n,r,Yu(),i);return ek(s),new Promise(()=>{})}_initialize(e){const n=e._key();if(this.eventManagers[n]){const{manager:i,promise:s}=this.eventManagers[n];return i?Promise.resolve(i):(tn(s,"If manager is not set, promise should be"),s)}const r=this.initAndGetManager(e);return this.eventManagers[n]={promise:r},r.catch(()=>{delete this.eventManagers[n]}),r}async initAndGetManager(e){const n=await zk(e),r=new Ek(e);return n.register("authEvent",i=>(M(i==null?void 0:i.authEvent,e,"invalid-auth-event"),{status:r.onEvent(i.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=n,r}_isIframeWebStorageSupported(e,n){this.iframes[e._key()].send(ba,{type:ba},i=>{var o;const s=(o=i==null?void 0:i[0])==null?void 0:o[ba];s!==void 0&&n(!!s),Mt(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const n=e._key();return this.originValidationPromises[n]||(this.originValidationPromises[n]=Ak(e)),this.originValidationPromises[n]}get _shouldInitProactively(){return py()||ay()||Ld()}}const Jk=Xk;var lp="@firebase/auth",ap="1.13.2";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */const nI=5*60,rI=Nm("authIdTokenMaxAge")||nI;let up=null;const iI=t=>async e=>{const n=e&&await e.getIdTokenResult(),r=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(r&&r>rI)return;const i=n==null?void 0:n.token;up!==i&&(up=i,await fetch(t,{method:i?"POST":"DELETE",headers:i?{Authorization:`Bearer ${i}`}:{}}))};function sI(t=jm()){const e=Xc(t,"auth");if(e.isInitialized())return e.getImmediate();const n=M1(t,{popupRedirectResolver:Jk,persistence:[uk,X1,Sy]}),r=Nm("authTokenSyncURL");if(r&&typeof isSecureContext=="boolean"&&isSecureContext){const s=new URL(r,location.origin);if(location.origin===s.origin){const o=iI(s.toString());K1(n,o,()=>o(n.currentUser)),G1(n,l=>o(l))}}const i=Rm("auth");return i&&z1(n,`http://${i}`),n}function oI(){var t;return((t=document.getElementsByTagName("head"))==null?void 0:t[0])??document}b1({loadJS(t){return new Promise((e,n)=>{const r=document.createElement("script");r.setAttribute("src",t),r.onload=e,r.onerror=i=>{const s=At("internal-error");s.customData=i,n(s)},r.type="text/javascript",r.charset="UTF-8",oI().appendChild(r)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});tI("Browser");const lI={apiKey:"AIzaSyBBsCbQtT7NuCCI6owVaGH7kNWpNbPJirA",authDomain:"pet-health-book-f8fe5.firebaseapp.com",databaseURL:"https://pet-health-book-f8fe5-default-rtdb.firebaseio.com",projectId:"pet-health-book-f8fe5",storageBucket:"pet-health-book-f8fe5.firebasestorage.app",messagingSenderId:"760283215334",appId:"1:760283215334:web:4aeb51a4c2cf2a288d1227"},Ny=Mm(lI),an=i1(Ny),so=sI(Ny),aI=new Bt,lt={病院:"🏥",ワクチン:"💉",薬:"💊",体重:"⚖️",フード:"🍖",その他:"📝"},Vn={病院:"#EF4444",ワクチン:"#8B5CF6",薬:"#3B82F6",体重:"#10B981",フード:"#F59E0B",その他:"#6B7280"},Ri={猫:"🐱",犬:"🐶",うさぎ:"🐰",ハムスター:"🐹",鳥:"🐦",魚:"🐠",その他:"🐾"},Oa={pets:[],records:[],nextPetId:1,nextRecordId:1};function uI(t){return t.map(e=>({...e,category:e.category==="診察"?"病院":e.category}))}function Fa(t){if(!t)return"";const e=new Date(t),n=new Date,r=n.getFullYear()-e.getFullYear(),i=n.getMonth()-e.getMonth(),s=r*12+i;return s<12?`${s}ヶ月`:`${Math.floor(s/12)}歳${s%12>0?s%12+"ヶ月":""}`}function cI(){var Hd;const[t,e]=q.useState("loading"),[n,r]=q.useState("loading"),[i,s]=q.useState(null),[o,l]=q.useState(!1),[a,u]=q.useState("home"),[f,h]=q.useState(null),[d,m]=q.useState({}),[y,w]=q.useState({}),[I,g]=q.useState("すべて"),[p,_]=q.useState(""),[S,P]=q.useState([]),[A,R]=q.useState(!1),[x,F]=q.useState(""),[j,N]=q.useState(""),[Q,Se]=q.useState(""),[ye,zn]=q.useState(!1),[pt,mi]=q.useState(!1),[D,z]=q.useState(!1);q.useEffect(()=>{const C=Q1(so,v=>{e(v),v||(r(null),s(null))});return()=>C()},[]),q.useEffect(()=>{if(!t||t==="loading")return;const C=on(an,`pet-health-book/members/${t.uid}`),v=Na(C,b=>{const W=b.val();r(W||null)});return()=>v()},[t]),q.useEffect(()=>{if(!n||n==="loading")return;const C=on(an,`pet-health-book/groups/${n}/data`),v=Na(C,b=>{const W=b.val();if(W){const gt=W.records?Array.isArray(W.records)?W.records:Object.values(W.records):[],U={...W,pets:W.pets?Array.isArray(W.pets)?W.pets:Object.values(W.pets):[],records:uI(gt)};s(U)}else vr(C,Oa),s(Oa)},b=>{console.error("Firebase sync error:",b),ze("⚠️ 同期エラー。オフラインで動作中"),s(Oa)});return()=>v()},[n]);async function B(){if(!t||t==="loading")return;const C=Math.random().toString(36).slice(2,10).toUpperCase();await vr(on(an,`pet-health-book/groups/${C}/info`),{createdBy:t.uid,createdAt:new Date().toISOString()}),await vr(on(an,`pet-health-book/members/${t.uid}`),C),r(C),ze("グループを作成しました 🎉")}async function ae(){if(!t||t==="loading")return;const C=x.trim().toUpperCase();if(!C){N("招待コードを入力してください");return}const v=on(an,`pet-health-book/groups/${C}/info`);if(!(await new Promise(W=>Na(v,W,{onlyOnce:!0}))).val()){N("招待コードが見つかりません");return}await vr(on(an,`pet-health-book/members/${t.uid}`),C),r(C),ze("グループに参加しました 🎉")}async function me(){!t||t==="loading"||confirm("このグループから抜けますか？（データは残ります）")&&(await vr(on(an,`pet-health-book/members/${t.uid}`),null),r(null),s(null))}function mr(C){if(!n||n==="loading")return;l(!0);const v=on(an,`pet-health-book/groups/${n}/data`);vr(v,C).then(()=>l(!1)).catch(b=>{console.error("Save error:",b),l(!1),ze("⚠️ 保存に失敗しました")})}function be(C){s(v=>{if(!v)return v;const b=C(v);return mr(b),b})}const ze=C=>{_(C),setTimeout(()=>_(""),2500)};function Pt(C,v){if(!i)return;const b=Bn(i.pets),W=b.findIndex(ee=>ee.id===C);if(v==="up"&&W===0||v==="down"&&W===b.length-1)return;const gt=v==="up"?W-1:W+1,U=b.map((ee,Ae)=>Ae===W?{...ee,order:gt}:Ae===gt?{...ee,order:W}:{...ee,order:Ae});be(ee=>({...ee,pets:U}))}function Bn(C){return[...C].sort((v,b)=>{const W=v.order!==void 0?v.order:v.id,gt=b.order!==void 0?b.order:b.id;return W-gt})}if(t==="loading")return c.jsxs("div",{style:{minHeight:"100vh",background:"#FDF6EE",display:"flex",alignItems:"center",justifyContent:"center",flexDirection:"column",gap:16},children:[c.jsx("div",{style:{fontSize:48},children:"🐾"}),c.jsx("div",{style:{color:"#9A7A5C",fontSize:16},children:"読み込み中..."})]});if(!t)return c.jsx("div",{style:{minHeight:"100vh",background:"#FDF6EE",display:"flex",alignItems:"center",justifyContent:"center",padding:24},children:c.jsxs("div",{style:{background:"#FFF",borderRadius:24,padding:"40px 32px",maxWidth:360,width:"100%",textAlign:"center",boxShadow:"0 4px 24px rgba(0,0,0,0.08)"},children:[c.jsx("div",{style:{fontSize:64,marginBottom:16},children:"🐾"}),c.jsx("h1",{style:{fontSize:24,fontWeight:700,color:"#3D2B1A",margin:"0 0 8px"},children:"ペット健康手帳"}),c.jsxs("p",{style:{color:"#9A7A5C",fontSize:14,margin:"0 0 32px",lineHeight:1.6},children:["大切な家族の健康を記録しよう。",c.jsx("br",{}),"Googleアカウントでログインしてください。"]}),c.jsxs("button",{onClick:async()=>{try{await pk(so,aI)}catch(C){console.error(C),alert("ログインに失敗しました: "+((C==null?void 0:C.message)||C))}},style:{display:"flex",alignItems:"center",justifyContent:"center",gap:12,width:"100%",background:"#FFF",border:"1.5px solid #E0D5C8",borderRadius:12,padding:"14px 20px",fontSize:15,fontWeight:600,color:"#3D2B1A",cursor:"pointer",boxShadow:"0 2px 8px rgba(0,0,0,0.06)"},children:[c.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 48 48",children:[c.jsx("path",{fill:"#EA4335",d:"M24 9.5c3.54 0 6.71 1.22 9.21 3.6l6.85-6.85C35.9 2.38 30.47 0 24 0 14.62 0 6.51 5.38 2.56 13.22l7.98 6.19C12.43 13.72 17.74 9.5 24 9.5z"}),c.jsx("path",{fill:"#4285F4",d:"M46.98 24.55c0-1.57-.15-3.09-.38-4.55H24v9.02h12.94c-.58 2.96-2.26 5.48-4.78 7.18l7.73 6c4.51-4.18 7.09-10.36 7.09-17.65z"}),c.jsx("path",{fill:"#FBBC05",d:"M10.53 28.59c-.48-1.45-.76-2.99-.76-4.59s.27-3.14.76-4.59l-7.98-6.19C.92 16.46 0 20.12 0 24c0 3.88.92 7.54 2.56 10.78l7.97-6.19z"}),c.jsx("path",{fill:"#34A853",d:"M24 48c6.48 0 11.93-2.13 15.89-5.81l-7.73-6c-2.18 1.48-4.97 2.31-8.16 2.31-6.26 0-11.57-4.22-13.47-9.91l-7.98 6.19C6.51 42.62 14.62 48 24 48z"})]}),"Googleでログイン"]}),c.jsx("p",{style:{color:"#BBA08A",fontSize:12,marginTop:20},children:"ログインした方のみデータにアクセスできます"})]})});if(n==="loading")return c.jsxs("div",{style:{minHeight:"100vh",background:"#FDF6EE",display:"flex",alignItems:"center",justifyContent:"center",flexDirection:"column",gap:16},children:[c.jsx("div",{style:{fontSize:48},children:"🐾"}),c.jsx("div",{style:{color:"#9A7A5C",fontSize:16},children:"読み込み中..."})]});if(!n)return c.jsx("div",{style:{minHeight:"100vh",background:"#FDF6EE",display:"flex",alignItems:"center",justifyContent:"center",padding:24},children:c.jsxs("div",{style:{background:"#FFF",borderRadius:24,padding:"36px 28px",maxWidth:380,width:"100%",boxShadow:"0 4px 24px rgba(0,0,0,0.08)"},children:[c.jsxs("div",{style:{textAlign:"center",marginBottom:28},children:[c.jsx("div",{style:{fontSize:48},children:"🏠"}),c.jsx("h2",{style:{fontSize:20,fontWeight:700,color:"#3D2B1A",margin:"12px 0 6px"},children:"グループを設定"}),c.jsxs("p",{style:{color:"#9A7A5C",fontSize:13,lineHeight:1.6},children:["家族で同じグループに入ると",c.jsx("br",{}),"データを共有できます"]})]}),c.jsx("button",{onClick:B,style:{width:"100%",background:"#C49A6C",color:"#FFF",border:"none",borderRadius:14,padding:"16px",fontSize:15,fontWeight:700,cursor:"pointer",marginBottom:12},children:"🆕 新しいグループを作る"}),c.jsx("div",{style:{textAlign:"center",color:"#BBA08A",fontSize:13,margin:"4px 0 12px"},children:"または"}),c.jsxs("div",{style:{background:"#FFF8F0",borderRadius:14,padding:16},children:[c.jsx("div",{style:{fontWeight:700,color:"#3D2B1A",fontSize:14,marginBottom:10},children:"👨‍👩‍👧 招待コードで参加"}),c.jsx("input",{style:{width:"100%",padding:"10px 14px",borderRadius:10,border:"1.5px solid #E8D5BC",fontSize:16,letterSpacing:4,textTransform:"uppercase",boxSizing:"border-box",textAlign:"center"},placeholder:"例: AB12CD34",value:x,onChange:C=>{F(C.target.value),N("")},maxLength:8}),j&&c.jsx("div",{style:{color:"#EF4444",fontSize:12,marginTop:6},children:j}),c.jsx("button",{onClick:ae,style:{width:"100%",background:"#3D2B1A",color:"#FFF",border:"none",borderRadius:10,padding:"12px",fontSize:14,fontWeight:700,cursor:"pointer",marginTop:10},children:"参加する"})]}),c.jsx("button",{onClick:()=>ep(so),style:{width:"100%",background:"none",border:"none",color:"#BBA08A",fontSize:13,cursor:"pointer",marginTop:20},children:"ログアウト"})]})});if(!i)return c.jsxs("div",{style:{minHeight:"100vh",background:"#FDF6EE",display:"flex",alignItems:"center",justifyContent:"center",flexDirection:"column",gap:16},children:[c.jsx("div",{style:{fontSize:48},children:"🐾"}),c.jsx("div",{style:{color:"#9A7A5C",fontSize:16},children:"データを読み込み中..."})]});const V=i.pets.find(C=>C.id===f)??null,Gl=i.records.filter(C=>C.petId===f).filter(C=>I==="すべて"||C.category===I).filter(C=>{if(!Q.trim())return!0;const v=Q.trim().toLowerCase();return C.title.toLowerCase().includes(v)||C.description.toLowerCase().includes(v)||C.date.includes(v)}).sort((C,v)=>v.date.localeCompare(C.date));function Dy(){const C=i.pets.length,v={id:i.nextPetId,name:d.name||"名前未設定",species:d.species||"その他",breed:d.breed||"",birthdate:d.birthdate||"",color:d.color||"#C49A6C",icon:Ri[d.species||""]||"🐾",photo:d.photo||"",weight:d.weight||"",microchip:d.microchip||"",insurance:d.insurance||"",vet:d.vet||"",notes:d.notes||"",order:C};be(b=>({...b,pets:[...b.pets,v],nextPetId:b.nextPetId+1})),ze(`${v.name}を追加しました 🎉`),u("home")}function by(){be(C=>({...C,pets:C.pets.map(v=>v.id===f?{...v,...d,icon:Ri[d.species||v.species]||v.icon,photo:d.photo??v.photo}:v)})),ze("プロフィールを更新しました ✅"),u("petDetail")}function Oy(C){confirm("このペットと全記録を削除しますか？")&&(be(v=>({...v,pets:v.pets.filter(b=>b.id!==C),records:v.records.filter(b=>b.petId!==C)})),u("home"),ze("削除しました"))}function Fy(){const C={id:i.nextRecordId,petId:f,date:y.date||new Date().toISOString().slice(0,10),category:y.category||"その他",title:y.title||"記録",description:y.description||"",weight:y.weight||"",nextDate:y.nextDate||""};be(v=>({...v,records:[...v.records,C],nextRecordId:v.nextRecordId+1})),ze("記録を追加しました 📝"),u("recordList")}function Wd(C){be(v=>({...v,records:v.records.filter(b=>b.id!==C)})),ze("記録を削除しました")}function Ly(){be(C=>({...C,records:C.records.map(v=>v.id===y.id?{...v,...y}:v)})),ze("記録を更新しました ✅"),u("recordList")}if(a==="home"){const C=Bn(i.pets);return c.jsxs(wr,{children:[c.jsxs("div",{style:{background:"linear-gradient(135deg, #FFF5E9, #FDE8D0)",borderRadius:20,padding:"24px 20px 20px",marginBottom:20,textAlign:"center",position:"relative",overflow:"hidden"},children:[c.jsx("div",{style:{position:"absolute",top:-10,right:-10,fontSize:80,opacity:.08,lineHeight:1},children:"🐾"}),c.jsx("div",{style:{position:"absolute",bottom:-10,left:-10,fontSize:60,opacity:.06,lineHeight:1},children:"🐱"}),c.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",gap:10,marginBottom:4},children:[c.jsx("span",{style:{fontSize:28},children:"🐾"}),c.jsx("h1",{style:{margin:0,fontSize:22,fontWeight:700,color:"#3D2B1A"},children:"ペット健康手帳"})]}),c.jsx("p",{style:{margin:"0 0 14px",color:"#9A7A5C",fontSize:13},children:"大切な家族の健康を記録しよう"}),c.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",gap:8,flexWrap:"wrap"},children:[t.photoURL&&c.jsx("img",{src:t.photoURL,alt:"avatar",style:{width:24,height:24,borderRadius:"50%",border:"2px solid #FFF"}}),c.jsx("span",{style:{fontSize:12,color:"#7A5C3A",fontWeight:600},children:t.displayName||t.email}),c.jsx("span",{style:{color:"#C49A6C",fontSize:10},children:"|"}),c.jsx("button",{onClick:()=>ep(so),style:{background:"none",border:"none",fontSize:12,color:"#9A7A5C",cursor:"pointer",padding:0},children:"ログアウト"})]}),c.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",gap:8,marginTop:10,flexWrap:"wrap"},children:[c.jsxs("div",{style:{background:"#FFF",borderRadius:20,padding:"4px 12px",fontSize:11,color:"#7A5C3A",fontWeight:600,letterSpacing:1,boxShadow:"0 1px 4px rgba(0,0,0,0.08)"},children:["🏠 ",n]}),o&&c.jsx("div",{style:{fontSize:11,color:"#9A7A5C",background:"#FFF",borderRadius:20,padding:"4px 10px"},children:"☁️ 同期中"}),c.jsx("button",{onClick:me,style:{background:"none",border:"none",fontSize:11,color:"#BBA08A",cursor:"pointer",padding:0},children:"グループを抜ける"})]})]}),(()=>{if(D)return null;const v=new Date().toISOString().slice(5,10),b=i.pets.filter(W=>W.birthdate&&W.birthdate.slice(5)===v);return b.length===0?null:c.jsxs("div",{style:{background:"linear-gradient(135deg, #FFF0DC, #FFD9A0)",border:"2px solid #C49A6C",borderRadius:16,padding:"16px 20px",marginBottom:16,position:"relative"},children:[c.jsx("button",{onClick:()=>z(!0),style:{position:"absolute",top:10,right:12,background:"none",border:"none",fontSize:18,cursor:"pointer",color:"#9A7A5C"},children:"✕"}),c.jsx("div",{style:{fontSize:28,marginBottom:6},children:"🎂🎉"}),c.jsxs("div",{style:{fontWeight:700,fontSize:16,color:"#3D2B1A",marginBottom:4},children:["今日は",b.map(W=>W.name).join("・"),"の誕生日！"]}),c.jsxs("div",{style:{fontSize:13,color:"#7A5C3A"},children:[b.map(W=>`${W.name}（${Fa(W.birthdate)}）`).join("、"),"、お誕生日おめでとう🐾"]})]})})(),c.jsxs("div",{style:{display:"flex",gap:8,marginBottom:16,justifyContent:"flex-end"},children:[i.pets.length>=2&&c.jsx("button",{onClick:()=>zn(!0),style:{background:"#FFF0DC",border:"none",borderRadius:20,padding:"8px 14px",fontSize:13,fontWeight:600,color:"#7A5C3A",cursor:"pointer"},children:"📊 体重比較"}),i.pets.length>=2&&c.jsx("button",{onClick:()=>mi(v=>!v),style:{background:pt?"#C49A6C":"#FFF0DC",border:"none",borderRadius:20,padding:"8px 14px",fontSize:13,fontWeight:600,color:pt?"#FFF":"#7A5C3A",cursor:"pointer"},children:pt?"✅ 完了":"↕️ 並び替え"})]}),pt&&c.jsx("div",{style:{background:"#FFF8EE",border:"1px solid #F0D9B0",borderRadius:12,padding:"10px 14px",marginBottom:12,fontSize:13,color:"#7A5C3A",textAlign:"center"},children:"↑↓ ボタンでペットの順番を変更できます"}),i.pets.length===0&&c.jsx(dI,{onStart:()=>{m({}),u("addPet")}}),c.jsxs("div",{style:T.petGrid,children:[C.map((v,b)=>c.jsxs("div",{style:{position:"relative"},children:[c.jsxs("button",{style:T.petCard,onClick:()=>{pt||(h(v.id),u("petDetail"))},children:[c.jsx("div",{style:{...T.petCardIcon,background:v.color+"33",overflow:"hidden"},children:v.photo?c.jsx("img",{src:v.photo,alt:v.name,style:{width:"100%",height:"100%",objectFit:"cover",borderRadius:"50%"}}):c.jsx("span",{style:{fontSize:40},children:v.icon})}),c.jsx("div",{style:T.petCardName,children:v.name}),c.jsxs("div",{style:T.petCardSub,children:[v.species,v.breed?` / ${v.breed}`:""]}),v.birthdate&&c.jsx("div",{style:T.petCardAge,children:Fa(v.birthdate)}),c.jsxs("div",{style:T.petCardRecords,children:["記録 ",i.records.filter(W=>W.petId===v.id).length,"件"]})]}),pt&&c.jsxs("div",{style:{position:"absolute",top:6,right:6,display:"flex",flexDirection:"column",gap:3},children:[c.jsx("button",{onClick:()=>Pt(v.id,"up"),disabled:b===0,style:{background:b===0?"#E8D5BC":"#C49A6C",border:"none",borderRadius:6,width:26,height:26,color:"#FFF",cursor:b===0?"default":"pointer",fontSize:13,display:"flex",alignItems:"center",justifyContent:"center"},children:"↑"}),c.jsx("button",{onClick:()=>Pt(v.id,"down"),disabled:b===C.length-1,style:{background:b===C.length-1?"#E8D5BC":"#C49A6C",border:"none",borderRadius:6,width:26,height:26,color:"#FFF",cursor:b===C.length-1?"default":"pointer",fontSize:13,display:"flex",alignItems:"center",justifyContent:"center"},children:"↓"})]})]},v.id)),!pt&&c.jsxs("button",{style:T.addPetCard,onClick:()=>{m({}),u("addPet")},children:[c.jsx("span",{style:{fontSize:32},children:"➕"}),c.jsx("div",{style:{marginTop:8,fontWeight:600,color:"#C49A6C"},children:"ペットを追加"})]})]}),ye&&c.jsx("div",{style:{position:"fixed",inset:0,background:"rgba(0,0,0,0.5)",zIndex:200,display:"flex",alignItems:"center",justifyContent:"center",padding:16},onClick:()=>zn(!1),children:c.jsxs("div",{style:{background:"#FFF",borderRadius:20,padding:24,width:"100%",maxWidth:640,maxHeight:"85vh",overflowY:"auto"},onClick:v=>v.stopPropagation(),children:[c.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:20},children:[c.jsx("div",{style:{fontWeight:700,fontSize:17,color:"#3D2B1A"},children:"📊 体重比較グラフ"}),c.jsx("button",{onClick:()=>zn(!1),style:{background:"none",border:"none",fontSize:20,cursor:"pointer",color:"#9A7A5C"},children:"✕"})]}),c.jsx(hI,{pets:i.pets,records:i.records})]})}),c.jsx(Cr,{message:p})]})}if(a==="petDetail"&&V){const C=i.pets.findIndex(U=>U.id===V.id),v=i.pets[C-1]??null,b=i.pets[C+1]??null,W=U=>{window._swipeStartX=U.touches[0].clientX},gt=U=>{const ee=window._swipeStartX??null;if(ee===null)return;const Ae=ee-U.changedTouches[0].clientX;Math.abs(Ae)<60||(Ae>0&&b&&h(b.id),Ae<0&&v&&h(v.id))};return c.jsxs(wr,{children:[i.pets.length>1&&c.jsx("div",{style:{display:"flex",justifyContent:"center",gap:6,marginBottom:12},children:i.pets.map(U=>c.jsx("button",{onClick:()=>h(U.id),style:{width:U.id===V.id?20:8,height:8,borderRadius:4,border:"none",cursor:"pointer",transition:"width 0.2s",background:U.id===V.id?V.color||"#C49A6C":"#E8D5BC",padding:0}},U.id))}),c.jsxs("div",{onTouchStart:W,onTouchEnd:gt,children:[c.jsxs("div",{style:{...T.petBanner,background:`linear-gradient(135deg, ${V.color}44, ${V.color}22)`},children:[V.photo?c.jsx("img",{src:V.photo,alt:V.name,style:{width:80,height:80,borderRadius:"50%",objectFit:"cover",flexShrink:0}}):c.jsx("span",{style:{fontSize:64},children:V.icon}),c.jsxs("div",{children:[c.jsx("h2",{style:{margin:0,fontSize:28,color:"#3D2B1A"},children:V.name}),c.jsxs("div",{style:{color:"#7A5C3A",marginTop:4},children:[V.species,V.breed?` / ${V.breed}`:"",V.birthdate&&c.jsxs("span",{style:{marginLeft:12},children:["🎂 ",Fa(V.birthdate)]})]})]}),c.jsxs("div",{style:{marginLeft:"auto",display:"flex",gap:8},children:[c.jsx(dp,{onClick:()=>{m({...V}),u("editPet")},title:"編集",children:"✏️"}),c.jsx(dp,{onClick:()=>Oy(V.id),title:"削除",danger:!0,children:"🗑️"})]})]}),c.jsxs("div",{style:T.infoGrid,children:[c.jsx(gI,{records:i.records,petId:V.id}),c.jsx(pI,{pet:V,onSave:U=>{be(ee=>({...ee,pets:ee.pets.map(Ae=>Ae.id===V.id?{...Ae,...U}:Ae)})),ze("病院情報を更新しました ✅")}}),[{label:"マイクロチップ",value:V.microchip||"—"},{label:"保険",value:V.insurance||"—"}].map(U=>c.jsxs("div",{style:T.infoCard,children:[c.jsx("div",{style:T.infoLabel,children:U.label}),c.jsx("div",{style:T.infoValue,children:U.value})]},U.label))]}),V.notes&&c.jsxs("div",{style:T.notesBox,children:[c.jsx("span",{style:{marginRight:6},children:"📌"}),c.jsx(Ud,{text:V.notes})]}),c.jsx("div",{style:T.sectionHeader,children:c.jsx("span",{children:"📊 カテゴリ別"})}),c.jsx("div",{style:T.categoryRow,children:Object.keys(lt).map(U=>{const ee=i.records.filter(Ae=>Ae.petId===V.id&&Ae.category===U).length;return c.jsxs("button",{style:T.catChip,onClick:()=>{g(U),Se(""),u("recordList")},children:[c.jsx("span",{children:lt[U]}),c.jsx("span",{style:{fontSize:11,color:"#7A5C3A"},children:U}),c.jsx("span",{style:{...T.catCount,background:Vn[U]},children:ee})]},U)})}),c.jsxs("div",{style:T.sectionHeader,children:[c.jsx("span",{children:"📅 カレンダー"}),c.jsx("button",{style:T.linkBtn,onClick:()=>{g("すべて"),Se(""),u("recordList")},children:"一覧で見る →"})]}),c.jsx(fI,{records:i.records.filter(U=>U.petId===V.id),onDayClick:U=>{U.length!==0&&(P(U),R(!0))}})]}),c.jsx("div",{style:T.fab,children:c.jsxs("div",{style:{display:"flex",gap:12},children:[c.jsx("button",{style:T.fabBtnBack,onClick:()=>u("home"),children:"← 戻る"}),c.jsx("button",{style:T.fabBtn,onClick:()=>{w({date:new Date().toISOString().slice(0,10)}),u("addRecord")},children:"＋ 記録を追加"})]})}),A&&c.jsx("div",{style:{position:"fixed",inset:0,background:"rgba(0,0,0,0.5)",zIndex:200,display:"flex",alignItems:"flex-end",justifyContent:"center"},onClick:()=>R(!1),children:c.jsxs("div",{style:{background:"#FDF6EE",borderRadius:"20px 20px 0 0",padding:24,width:"100%",maxWidth:600,maxHeight:"70vh",overflowY:"auto"},onClick:U=>U.stopPropagation(),children:[c.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:16},children:[c.jsxs("div",{style:{fontWeight:700,fontSize:16,color:"#3D2B1A"},children:["📋 ",(Hd=S[0])==null?void 0:Hd.date,"の記録"]}),c.jsx("button",{onClick:()=>R(!1),style:{background:"none",border:"none",fontSize:20,cursor:"pointer",color:"#9A7A5C"},children:"✕"})]}),S.map(U=>c.jsx(hp,{record:U,onDelete:ee=>{Wd(ee),R(!1)},onEdit:ee=>{w({...ee}),R(!1),u("editRecord")},expanded:!0},U.id))]})}),c.jsx(Cr,{message:p})]})}if(a==="addPet"||a==="editPet"){const C=a==="editPet";return c.jsxs(wr,{children:[c.jsx(La,{onClick:()=>u(C?"petDetail":"home")}),c.jsx("h2",{style:T.formTitle,children:C?"プロフィール編集":"新しいペットを追加"}),c.jsxs("div",{style:T.form,children:[c.jsx(ue,{label:"アイコン写真",children:c.jsxs("div",{style:{display:"flex",alignItems:"center",gap:16},children:[c.jsx("div",{style:{width:80,height:80,borderRadius:"50%",background:d.color?d.color+"33":"#C49A6C33",overflow:"hidden",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0,border:"2px dashed #C49A6C"},children:d.photo?c.jsx("img",{src:d.photo,alt:"preview",style:{width:"100%",height:"100%",objectFit:"cover"}}):c.jsx("span",{style:{fontSize:36},children:Ri[d.species||""]||"🐾"})}),c.jsxs("div",{style:{flex:1},children:[c.jsxs("label",{style:{display:"inline-block",background:"#C49A6C",color:"#FFF",borderRadius:10,padding:"10px 16px",cursor:"pointer",fontSize:14,fontWeight:600},children:["📷 写真を選択",c.jsx("input",{type:"file",accept:"image/*",style:{display:"none"},onChange:v=>{var gt;const b=(gt=v.target.files)==null?void 0:gt[0];if(!b)return;const W=new FileReader;W.onload=U=>{var Ae;const ee=new Image;ee.onload=()=>{const Ls=document.createElement("canvas"),Ms=200;Ls.width=Ms,Ls.height=Ms;const My=Ls.getContext("2d"),js=Math.min(ee.width,ee.height),jy=(ee.width-js)/2,zy=(ee.height-js)/2;My.drawImage(ee,jy,zy,js,js,0,0,Ms,Ms),m(By=>({...By,photo:Ls.toDataURL("image/jpeg",.7)}))},ee.src=(Ae=U.target)==null?void 0:Ae.result},W.readAsDataURL(b)}})]}),d.photo&&c.jsx("button",{style:{display:"block",marginTop:8,background:"none",border:"none",color:"#EF4444",cursor:"pointer",fontSize:13},onClick:()=>m(v=>({...v,photo:""})),children:"🗑️ 写真を削除"})]})]})}),c.jsx(ue,{label:"名前 *",children:c.jsx("input",{style:T.input,value:d.name||"",onChange:v=>m(b=>({...b,name:v.target.value})),placeholder:"例: じゅうべい"})}),c.jsx(ue,{label:"種類",children:c.jsxs("select",{style:T.input,value:d.species||"",onChange:v=>m(b=>({...b,species:v.target.value})),children:[c.jsx("option",{value:"",children:"選択してください"}),Object.keys(Ri).map(v=>c.jsxs("option",{value:v,children:[Ri[v]," ",v]},v))]})}),c.jsx(ue,{label:"品種",children:c.jsx("input",{style:T.input,value:d.breed||"",onChange:v=>m(b=>({...b,breed:v.target.value})),placeholder:"例: アメリカンショートヘア"})}),c.jsx(ue,{label:"生年月日",children:c.jsx("input",{type:"date",style:T.input,value:d.birthdate||"",onChange:v=>m(b=>({...b,birthdate:v.target.value}))})}),c.jsx(ue,{label:"体重 (kg)",children:c.jsx("input",{type:"number",step:"0.1",style:T.input,value:d.weight||"",onChange:v=>m(b=>({...b,weight:v.target.value})),placeholder:"例: 4.2"})}),c.jsx(ue,{label:"かかりつけ病院",children:c.jsx("input",{style:T.input,value:d.vet||"",onChange:v=>m(b=>({...b,vet:v.target.value})),placeholder:"例: ○○動物病院"})}),c.jsx(ue,{label:"マイクロチップ番号",children:c.jsx("input",{style:T.input,value:d.microchip||"",onChange:v=>m(b=>({...b,microchip:v.target.value}))})}),c.jsx(ue,{label:"ペット保険",children:c.jsx("input",{style:T.input,value:d.insurance||"",onChange:v=>m(b=>({...b,insurance:v.target.value})),placeholder:"例: アニコム"})}),c.jsx(ue,{label:"テーマカラー",children:c.jsx("input",{type:"color",style:{...T.input,height:44,padding:4},value:d.color||"#C49A6C",onChange:v=>m(b=>({...b,color:v.target.value}))})}),c.jsx(ue,{label:"メモ",children:c.jsx("textarea",{style:{...T.input,height:80,resize:"vertical"},value:d.notes||"",onChange:v=>m(b=>({...b,notes:v.target.value})),placeholder:"アレルギー、好き嫌いなど"})}),c.jsx("button",{style:T.primaryBtn,onClick:C?by:Dy,children:C?"✅ 更新する":"🎉 追加する"})]}),c.jsx(Cr,{message:p})]})}return a==="addRecord"&&V?c.jsxs(wr,{children:[c.jsx(La,{onClick:()=>u("petDetail")}),c.jsx("h2",{style:T.formTitle,children:"記録を追加"}),c.jsxs("p",{style:{textAlign:"center",color:"#7A5C3A",marginTop:-16,marginBottom:24},children:[V.icon," ",V.name]}),c.jsxs("div",{style:T.form,children:[c.jsx(ue,{label:"日付 *",children:c.jsx("input",{type:"date",style:T.input,value:y.date||"",onChange:C=>w(v=>({...v,date:C.target.value}))})}),c.jsx(ue,{label:"カテゴリ",children:c.jsx("div",{style:T.catSelector,children:Object.keys(lt).map(C=>c.jsxs("button",{style:{...T.catOption,background:y.category===C?Vn[C]+"33":"#FFF7EE",border:y.category===C?`2px solid ${Vn[C]}`:"2px solid transparent"},onClick:()=>w(v=>({...v,category:C})),children:[c.jsx("span",{children:lt[C]}),c.jsx("span",{style:{fontSize:12},children:C})]},C))})}),c.jsx(ue,{label:"タイトル *",children:c.jsx("input",{style:T.input,value:y.title||"",onChange:C=>w(v=>({...v,title:C.target.value})),placeholder:"例: 年次健診"})}),c.jsx(ue,{label:"詳細メモ",children:c.jsx("textarea",{style:{...T.input,height:100,resize:"vertical"},value:y.description||"",onChange:C=>w(v=>({...v,description:C.target.value})),placeholder:"診断内容、投薬量、気づいたことなど"})}),y.category==="体重"&&c.jsx(ue,{label:"体重 (kg)",children:c.jsx("input",{type:"number",step:"0.1",style:T.input,value:y.weight||"",onChange:C=>w(v=>({...v,weight:C.target.value})),placeholder:"例: 4.2"})}),c.jsx(ue,{label:"次回予定日",children:c.jsx("input",{type:"date",style:T.input,value:y.nextDate||"",onChange:C=>w(v=>({...v,nextDate:C.target.value}))})}),c.jsx("button",{style:T.primaryBtn,onClick:Fy,children:"📝 記録する"})]}),c.jsx(Cr,{message:p})]}):a==="editRecord"&&V?c.jsxs(wr,{children:[c.jsx(La,{onClick:()=>u("recordList")}),c.jsx("h2",{style:T.formTitle,children:"記録を編集"}),c.jsxs("p",{style:{textAlign:"center",color:"#7A5C3A",marginTop:-16,marginBottom:24},children:[V.icon," ",V.name]}),c.jsxs("div",{style:T.form,children:[c.jsx(ue,{label:"日付 *",children:c.jsx("input",{type:"date",style:T.input,value:y.date||"",onChange:C=>w(v=>({...v,date:C.target.value}))})}),c.jsx(ue,{label:"カテゴリ",children:c.jsx("div",{style:T.catSelector,children:Object.keys(lt).map(C=>c.jsxs("button",{style:{...T.catOption,background:y.category===C?Vn[C]+"33":"#FFF7EE",border:y.category===C?`2px solid ${Vn[C]}`:"2px solid transparent"},onClick:()=>w(v=>({...v,category:C})),children:[c.jsx("span",{children:lt[C]}),c.jsx("span",{style:{fontSize:12},children:C})]},C))})}),c.jsx(ue,{label:"タイトル *",children:c.jsx("input",{style:T.input,value:y.title||"",onChange:C=>w(v=>({...v,title:C.target.value})),placeholder:"例: 年次健診"})}),c.jsx(ue,{label:"詳細メモ",children:c.jsx("textarea",{style:{...T.input,height:100,resize:"vertical"},value:y.description||"",onChange:C=>w(v=>({...v,description:C.target.value})),placeholder:"診断内容、投薬量、気づいたことなど"})}),y.category==="体重"&&c.jsx(ue,{label:"体重 (kg)",children:c.jsx("input",{type:"number",step:"0.1",style:T.input,value:y.weight||"",onChange:C=>w(v=>({...v,weight:C.target.value})),placeholder:"例: 4.2"})}),c.jsx(ue,{label:"次回予定日",children:c.jsx("input",{type:"date",style:T.input,value:y.nextDate||"",onChange:C=>w(v=>({...v,nextDate:C.target.value}))})}),c.jsx("button",{style:T.primaryBtn,onClick:Ly,children:"✅ 更新する"})]}),c.jsx(Cr,{message:p})]}):a==="recordList"&&V?c.jsxs(wr,{children:[c.jsx("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:16},children:c.jsxs("h2",{style:{margin:0,fontSize:20,color:"#3D2B1A"},children:[V.icon," ",V.name,"の記録"]})}),c.jsxs("div",{style:{position:"relative",marginBottom:14},children:[c.jsx("span",{style:{position:"absolute",left:12,top:"50%",transform:"translateY(-50%)",fontSize:16,color:"#BBA08A",pointerEvents:"none"},children:"🔍"}),c.jsx("input",{style:{...T.input,paddingLeft:36,paddingRight:Q?36:14},placeholder:"タイトル・メモ・日付で検索...",value:Q,onChange:C=>Se(C.target.value)}),Q&&c.jsx("button",{onClick:()=>Se(""),style:{position:"absolute",right:10,top:"50%",transform:"translateY(-50%)",background:"none",border:"none",fontSize:16,color:"#BBA08A",cursor:"pointer",padding:2},children:"✕"})]}),c.jsx("div",{style:{display:"flex",gap:8,flexWrap:"wrap",marginBottom:20},children:["すべて",...Object.keys(lt)].map(C=>c.jsxs("button",{style:{...T.filterChip,background:I===C?"#C49A6C":"#FFF0DC",color:I===C?"#FFF":"#7A5C3A"},onClick:()=>g(C),children:[C!=="すべて"&&lt[C]+" ",C]},C))}),(Q||I!=="すべて")&&c.jsxs("div",{style:{fontSize:12,color:"#9A7A5C",marginBottom:12,paddingLeft:4},children:[Gl.length,"件の記録",Q&&c.jsxs("span",{children:[" 「",Q,"」"]}),I!=="すべて"&&c.jsxs("span",{children:[" [",I,"]"]})]}),Gl.length===0?c.jsx(_I,{icon:"📭",msg:Q?"検索結果がありません":"該当する記録がありません"}):Gl.map(C=>c.jsx(hp,{record:C,onDelete:Wd,onEdit:v=>{w({...v}),u("editRecord")},expanded:!0},C.id)),c.jsxs("div",{style:{position:"fixed",bottom:24,left:"50%",transform:"translateX(-50%)",display:"flex",gap:12,zIndex:100},children:[c.jsx("button",{style:{background:"#FFF",color:"#7A5C3A",border:"1.5px solid #E8D5BC",borderRadius:30,padding:"14px 22px",fontSize:15,fontWeight:700,cursor:"pointer",boxShadow:"0 4px 20px rgba(0,0,0,0.12)",whiteSpace:"nowrap"},onClick:()=>u("petDetail"),children:"← 戻る"}),c.jsx("button",{style:{background:"#C49A6C",color:"#FFF",border:"none",borderRadius:30,padding:"14px 22px",fontSize:15,fontWeight:700,cursor:"pointer",boxShadow:"0 4px 20px rgba(196,154,108,0.4)",whiteSpace:"nowrap"},onClick:()=>{w({date:new Date().toISOString().slice(0,10)}),u("addRecord")},children:"＋ 記録を追加"})]}),c.jsx(Cr,{message:p})]}):c.jsx("div",{style:{padding:40,textAlign:"center"},children:"読み込み中..."})}function dI({onStart:t}){const e=[{icon:"🐾",title:"ペットを登録する",desc:"名前・種類・生年月日・写真などのプロフィールを登録します。複数のペットを管理できます。"},{icon:"📝",title:"健康記録をつける",desc:"病院・ワクチン・薬・体重・フードなどをカテゴリごとに記録。カレンダーで一覧確認できます。"},{icon:"⚖️",title:"体重の変化を確認する",desc:"体重記録をグラフで可視化。3匹まとめて比較グラフも見られます。"},{icon:"👨‍👩‍👧",title:"家族と共有する",desc:"グループコードを共有するだけで、家族全員がリアルタイムでデータを閲覧・更新できます。"}];return c.jsxs("div",{style:{marginBottom:28},children:[c.jsxs("div",{style:{background:"linear-gradient(135deg, #FFF0DC, #FDE8D0)",borderRadius:16,padding:"20px 20px 16px",marginBottom:16,textAlign:"center",border:"1.5px dashed #C49A6C"},children:[c.jsx("div",{style:{fontSize:40,marginBottom:8},children:"🎉"}),c.jsx("div",{style:{fontWeight:700,fontSize:16,color:"#3D2B1A",marginBottom:6},children:"ペット健康手帳へようこそ！"}),c.jsxs("div",{style:{fontSize:13,color:"#7A5C3A",lineHeight:1.7},children:["大切なペットの健康情報を家族みんなで管理できます。",c.jsx("br",{}),"まずはペットを登録してみましょう。"]}),c.jsx("button",{onClick:t,style:{marginTop:14,background:"#C49A6C",color:"#FFF",border:"none",borderRadius:24,padding:"12px 28px",fontSize:15,fontWeight:700,cursor:"pointer",boxShadow:"0 3px 12px rgba(196,154,108,0.4)"},children:"🐾 最初のペットを登録する"})]}),c.jsx("div",{style:{fontSize:12,fontWeight:700,color:"#9A7A5C",textTransform:"uppercase",letterSpacing:1,marginBottom:10,paddingLeft:4},children:"できること"}),c.jsx("div",{style:{display:"flex",flexDirection:"column",gap:10},children:e.map((n,r)=>c.jsxs("div",{style:{background:"#FFF",borderRadius:14,padding:"14px 16px",display:"flex",alignItems:"flex-start",gap:14,boxShadow:"0 1px 8px rgba(0,0,0,0.05)"},children:[c.jsx("div",{style:{fontSize:28,lineHeight:1,flexShrink:0,marginTop:2},children:n.icon}),c.jsxs("div",{children:[c.jsxs("div",{style:{fontWeight:700,fontSize:14,color:"#3D2B1A",marginBottom:3},children:[c.jsx("span",{style:{background:"#C49A6C",color:"#FFF",borderRadius:10,fontSize:10,fontWeight:700,padding:"1px 7px",marginRight:7},children:r+1}),n.title]}),c.jsx("div",{style:{fontSize:13,color:"#7A5C3A",lineHeight:1.6},children:n.desc})]})]},r))}),c.jsx("div",{style:{textAlign:"center",marginTop:14,fontSize:12,color:"#BBA08A"},children:"ペットを登録すると、この案内は消えます"})]})}const cp=["#C49A6C","#EF4444","#3B82F6","#10B981","#8B5CF6"];function hI({pets:t,records:e}){const[n,r]=q.useState(3),i=(()=>{if(n===0)return"";const N=new Date;return N.setMonth(N.getMonth()-n),N.toISOString().slice(0,10)})(),s=t.map((N,Q)=>{const Se=e.filter(ye=>ye.petId===N.id&&ye.category==="体重"&&ye.weight).filter(ye=>n===0||ye.date>=i).map(ye=>({date:ye.date,kg:parseFloat(ye.weight)})).filter(ye=>!isNaN(ye.kg)).sort((ye,zn)=>ye.date.localeCompare(zn.date));return{pet:N,data:Se,color:cp[Q%cp.length]}}).filter(N=>N.data.length>0);if(s.length===0)return c.jsxs("div",{style:{textAlign:"center",padding:"40px 0",color:"#9A7A5C"},children:[c.jsx("div",{style:{fontSize:40,marginBottom:12},children:"⚖️"}),c.jsx("div",{children:"体重記録がありません"}),c.jsx("div",{style:{fontSize:12,marginTop:8},children:"各ペットの「体重」カテゴリで記録を追加してください"})]});const o=s.flatMap(N=>N.data.map(Q=>Q.date)).sort(),l=s.flatMap(N=>N.data.map(Q=>Q.kg)),a=o[0],u=o[o.length-1],f=Math.min(...l),h=Math.max(...l),d=520,m=220,y=52,w=16,I=20,g=36,p=d-y-w,_=m-I-g,P=(h-f||.5)*.15,A=f-P,R=h+P,x=N=>{if(a===u)return y+p/2;const Q=N.localeCompare(a)/u.localeCompare(a);return y+Q*p},F=N=>I+(1-(N-A)/(R-A))*_,j=Array.from({length:4},(N,Q)=>A+(R-A)*(Q/3));return c.jsxs("div",{children:[c.jsx("div",{style:{display:"flex",gap:6,marginBottom:16,justifyContent:"center"},children:[1,3,6,0].map(N=>c.jsx("button",{onClick:()=>r(N),style:{background:n===N?"#C49A6C":"#FFF0DC",border:"none",borderRadius:16,padding:"6px 14px",fontSize:13,fontWeight:600,color:n===N?"#FFF":"#7A5C3A",cursor:"pointer"},children:N===0?"全期間":`${N}ヶ月`},N))}),c.jsx("div",{style:{display:"flex",gap:12,flexWrap:"wrap",marginBottom:12,justifyContent:"center"},children:s.map(N=>c.jsxs("div",{style:{display:"flex",alignItems:"center",gap:6,fontSize:13,color:"#3D2B1A"},children:[c.jsx("div",{style:{width:28,height:3,background:N.color,borderRadius:2}}),c.jsx("span",{style:{fontWeight:600},children:N.pet.name}),N.data.length>0&&c.jsxs("span",{style:{color:"#9A7A5C",fontSize:12},children:["(",N.data[N.data.length-1].kg.toFixed(2),"kg)"]})]},N.pet.id))}),c.jsxs("svg",{viewBox:`0 0 ${d} ${m}`,style:{width:"100%",height:"auto",overflow:"visible"},children:[j.map((N,Q)=>c.jsxs("g",{children:[c.jsx("line",{x1:y,y1:F(N),x2:y+p,y2:F(N),stroke:"#F0E8DC",strokeWidth:"1"}),c.jsx("text",{x:y-6,y:F(N)+4,textAnchor:"end",fontSize:"9",fill:"#9A7A5C",children:N.toFixed(2)})]},Q)),c.jsx("line",{x1:y,y1:I,x2:y,y2:I+_,stroke:"#E8D5BC",strokeWidth:"1"}),c.jsx("line",{x1:y,y1:I+_,x2:y+p,y2:I+_,stroke:"#E8D5BC",strokeWidth:"1"}),s.map(N=>{if(N.data.length===0)return null;const Q=N.data.map(Se=>`${x(Se.date)},${F(Se.kg)}`).join(" ");return c.jsxs("g",{children:[c.jsx("polyline",{points:Q,fill:"none",stroke:N.color,strokeWidth:"2.5",strokeLinejoin:"round",strokeLinecap:"round"}),N.data.map((Se,ye)=>c.jsx("circle",{cx:x(Se.date),cy:F(Se.kg),r:"4",fill:N.color,stroke:"#FFF",strokeWidth:"1.5"},ye))]},N.pet.id)}),a&&c.jsxs(c.Fragment,{children:[c.jsx("text",{x:y,y:m-4,textAnchor:"start",fontSize:"9",fill:"#9A7A5C",children:a.slice(5)}),a!==u&&c.jsx("text",{x:y+p,y:m-4,textAnchor:"end",fontSize:"9",fill:"#9A7A5C",children:u.slice(5)})]})]}),t.filter(N=>!s.find(Q=>Q.pet.id===N.id)).length>0&&c.jsxs("div",{style:{fontSize:12,color:"#BBA08A",textAlign:"center",marginTop:8},children:["※ ",t.filter(N=>!s.find(Q=>Q.pet.id===N.id)).map(N=>N.name).join("・")," は体重記録なし"]})]})}function fI({records:t,onDayClick:e}){const n=new Date,[r,i]=q.useState(n.getFullYear()),[s,o]=q.useState(n.getMonth()),l=new Date(r,s,1).getDay(),a=new Date(r,s+1,0).getDate(),u={};t.forEach(p=>{u[p.date]||(u[p.date]=[]),u[p.date].push(p)});const f=`${r}-${String(s+1).padStart(2,"0")}`,h=n.toISOString().slice(0,10),d=()=>{s===0?(i(p=>p-1),o(11)):o(p=>p-1)},m=()=>{s===11?(i(p=>p+1),o(0)):o(p=>p+1)},y=()=>{const p=t.map(S=>S.date).filter(Boolean).sort();if(p.length===0)return;const _=p[0];i(parseInt(_.slice(0,4))),o(parseInt(_.slice(5,7))-1)},w=()=>{i(n.getFullYear()),o(n.getMonth())},I=r===n.getFullYear()&&s===n.getMonth(),g=["日","月","火","水","木","金","土"];return c.jsxs("div",{style:{background:"#FFF",borderRadius:16,padding:"16px",boxShadow:"0 2px 12px rgba(0,0,0,0.06)",marginBottom:80},children:[c.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:8},children:[c.jsx("button",{onClick:d,style:{background:"#FFF0DC",border:"none",borderRadius:10,fontSize:18,cursor:"pointer",color:"#C49A6C",padding:"8px 14px",fontWeight:700,lineHeight:1},children:"‹"}),c.jsx("div",{style:{textAlign:"center"},children:c.jsxs("div",{style:{fontWeight:700,fontSize:16,color:"#3D2B1A"},children:[r,"年 ",s+1,"月"]})}),c.jsx("button",{onClick:m,style:{background:"#FFF0DC",border:"none",borderRadius:10,fontSize:18,cursor:"pointer",color:"#C49A6C",padding:"8px 14px",fontWeight:700,lineHeight:1},children:"›"})]}),c.jsxs("div",{style:{display:"flex",gap:8,marginBottom:12,justifyContent:"center"},children:[c.jsx("button",{onClick:y,style:{background:"none",border:"1px solid #E8D5BC",borderRadius:20,padding:"4px 12px",fontSize:12,color:"#7A5C3A",cursor:"pointer"},children:"⏮ 最古の記録"}),!I&&c.jsx("button",{onClick:w,style:{background:"#C49A6C",border:"none",borderRadius:20,padding:"4px 12px",fontSize:12,color:"#FFF",cursor:"pointer",fontWeight:600},children:"今月へ戻る"})]}),c.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(7, 1fr)",gap:2,marginBottom:4},children:g.map((p,_)=>c.jsx("div",{style:{textAlign:"center",fontSize:11,fontWeight:700,color:_===0?"#EF4444":_===6?"#3B82F6":"#9A7A5C",padding:"4px 0"},children:p},p))}),c.jsxs("div",{style:{display:"grid",gridTemplateColumns:"repeat(7, 1fr)",gap:2},children:[Array.from({length:l}).map((p,_)=>c.jsx("div",{},`e${_}`)),Array.from({length:a}).map((p,_)=>{const S=_+1,P=`${f}-${String(S).padStart(2,"0")}`,A=u[P]||[],R=P===h,x=(l+_)%7,F=A.length>0,j=[...new Set(A.map(N=>N.category))].slice(0,3);return c.jsxs("div",{onClick:()=>e(A),style:{borderRadius:10,padding:"6px 2px 4px",textAlign:"center",cursor:F?"pointer":"default",background:R?"#C49A6C22":F?"#FFF7EE":"transparent",border:R?"2px solid #C49A6C":F?"1px solid #F0D9B0":"1px solid transparent",minHeight:52,display:"flex",flexDirection:"column",alignItems:"center",gap:2,transition:"background .15s"},children:[c.jsx("div",{style:{fontSize:13,fontWeight:R?700:400,color:x===0?"#EF4444":x===6?"#3B82F6":"#3D2B1A"},children:S}),c.jsx("div",{style:{display:"flex",flexWrap:"wrap",justifyContent:"center",gap:1},children:j.map(N=>c.jsx("span",{style:{fontSize:11,background:Vn[N]+"33",borderRadius:4,padding:"0 2px",lineHeight:1.4},children:lt[N]},N))}),A.length>0&&c.jsxs("div",{style:{fontSize:9,color:"#C49A6C",fontWeight:700},children:[A.length,"件"]})]},S)})]}),c.jsx("div",{style:{display:"flex",flexWrap:"wrap",gap:8,marginTop:14,paddingTop:12,borderTop:"1px solid #F0E8DC"},children:Object.keys(lt).map(p=>c.jsxs("div",{style:{display:"flex",alignItems:"center",gap:3,fontSize:11,color:"#7A5C3A"},children:[c.jsx("span",{children:lt[p]}),p]},p))})]})}function Ud({text:t,style:e}){const n=/(https?:\/\/[^\s]+)/g,r=t.split(n);return c.jsx("span",{style:e,children:r.map((i,s)=>n.test(i)?c.jsx("a",{href:i,target:"_blank",rel:"noopener noreferrer",style:{color:"#C49A6C",textDecoration:"underline",wordBreak:"break-all"},onClick:o=>o.stopPropagation(),children:i},s):i)})}function pI({pet:t,onSave:e}){const[n,r]=q.useState(!1),[i,s]=q.useState({vet:t.vet||"",vetPhone:t.vetPhone||"",vetAddress:t.vetAddress||"",vetHours:t.vetHours||"",vetNote:t.vetNote||""}),o=t.vet||t.vetPhone||t.vetAddress;function l(){e(i),r(!1)}const a=t.vetPhone?"tel:"+t.vetPhone.replace(/[^\d+]/g,""):"";return c.jsxs(c.Fragment,{children:[c.jsxs("div",{style:{...T.infoCard,cursor:"pointer"},onClick:()=>{s({vet:t.vet||"",vetPhone:t.vetPhone||"",vetAddress:t.vetAddress||"",vetHours:t.vetHours||"",vetNote:t.vetNote||""}),r(!0)},children:[c.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center"},children:[c.jsx("div",{style:T.infoLabel,children:"かかりつけ病院"}),c.jsx("span",{style:{fontSize:11,color:"#C49A6C"},children:"✏️ 編集"})]}),c.jsx("div",{style:{fontSize:14,fontWeight:600,color:"#3D2B1A",marginTop:4},children:t.vet||"—"}),t.vetPhone&&c.jsxs("div",{style:{fontSize:12,color:"#7A5C3A",marginTop:3},children:["📞"," ",c.jsx("a",{href:a,onClick:u=>u.stopPropagation(),style:{color:"#3B82F6",textDecoration:"none",fontWeight:600},children:t.vetPhone})]}),t.vetAddress&&c.jsxs("div",{style:{fontSize:11,color:"#9A7A5C",marginTop:2},children:["📍"," ",c.jsx("a",{href:`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(t.vetAddress)}`,target:"_blank",rel:"noopener noreferrer",onClick:u=>u.stopPropagation(),style:{color:"#3B82F6",textDecoration:"none"},children:t.vetAddress})]}),t.vetHours&&c.jsxs("div",{style:{fontSize:11,color:"#9A7A5C",marginTop:2},children:["🕐 ",t.vetHours]}),t.vetNote&&c.jsxs("div",{style:{fontSize:11,color:"#9A7A5C",marginTop:2},children:["📝 ",c.jsx(Ud,{text:t.vetNote})]}),!o&&c.jsx("div",{style:{fontSize:12,color:"#BBA08A",marginTop:4},children:"タップして追加"})]}),n&&c.jsx("div",{style:{position:"fixed",inset:0,background:"rgba(0,0,0,0.5)",zIndex:200,display:"flex",alignItems:"flex-end",justifyContent:"center"},onClick:()=>r(!1),children:c.jsxs("div",{style:{background:"#FDF6EE",borderRadius:"20px 20px 0 0",padding:24,width:"100%",maxWidth:600,maxHeight:"85vh",overflowY:"auto"},onClick:u=>u.stopPropagation(),children:[c.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:20},children:[c.jsx("div",{style:{fontWeight:700,fontSize:17,color:"#3D2B1A"},children:"🏥 病院情報を編集"}),c.jsx("button",{onClick:()=>r(!1),style:{background:"none",border:"none",fontSize:20,cursor:"pointer",color:"#9A7A5C"},children:"✕"})]}),c.jsx("div",{style:{display:"flex",flexDirection:"column",gap:14},children:[{key:"vet",label:"病院名",placeholder:"例: アシスト動物病院",icon:"🏥"},{key:"vetPhone",label:"電話番号",placeholder:"例: 03-1234-5678",icon:"📞"},{key:"vetAddress",label:"住所",placeholder:"例: 東京都渋谷区...",icon:"📍"},{key:"vetHours",label:"診療時間",placeholder:"例: 9:00〜19:00 (水休)",icon:"🕐"},{key:"vetNote",label:"メモ",placeholder:"担当医の名前など",icon:"📝"}].map(({key:u,label:f,placeholder:h,icon:d})=>c.jsxs("div",{children:[c.jsxs("label",{style:{display:"block",fontSize:13,fontWeight:600,color:"#5C3A1E",marginBottom:5},children:[d," ",f]}),u==="vetNote"?c.jsx("textarea",{style:{...T.input,height:72,resize:"vertical"},value:i[u],onChange:m=>s(y=>({...y,[u]:m.target.value})),placeholder:h}):c.jsx("input",{style:T.input,value:i[u],onChange:m=>s(y=>({...y,[u]:m.target.value})),placeholder:h})]},u))}),c.jsx("button",{style:{...T.primaryBtn,marginTop:20},onClick:l,children:"✅ 保存する"})]})})]})}function gI({records:t,petId:e}){const[n,r]=q.useState(6),i=(()=>{if(n===0)return"";const d=new Date;return d.setMonth(d.getMonth()-n),d.toISOString().slice(0,10)})(),s=t.filter(d=>d.petId===e&&d.category==="体重"&&d.weight).map(d=>({date:d.date,kg:parseFloat(d.weight)})).filter(d=>!isNaN(d.kg)).sort((d,m)=>d.date.localeCompare(m.date)),o=s.filter(d=>n===0||d.date>=i),l=o.length>0?o:s;if(s.length===0)return c.jsxs("div",{style:{...T.infoCard,gridColumn:"span 2"},children:[c.jsx("div",{style:T.infoLabel,children:"体重"}),c.jsx("div",{style:T.infoValue,children:"—"})]});const a=s[s.length-1],u=l.reduce((d,m)=>d.kg>=m.kg?d:m),f=l.reduce((d,m)=>d.kg<=m.kg?d:m),h=()=>{const d=l.slice().reverse().map((y,w,I)=>{const g=I[w+1],p=g?y.kg-g.kg:null,_=p===null?"—":p>0?`+${p.toFixed(2)}`:p.toFixed(2);return`<tr>
      ...
      <body><h2>⚖️ 体重記録</h2>
      <p style="color:#9A7A5C;font-size:13px;">${l.length}件</p>
