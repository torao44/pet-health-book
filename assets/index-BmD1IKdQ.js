 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(D,z){var B=D.length;D.push(z);e:for(;0<B;){var ae=B-1>>>1,me=D[ae];if(0<i(me,z))D[ae]=z,D[B]=me,B=ae;else break e}}function n(D){return D.length===0?null:D[0]}function r(D){if(D.length===0)return null;var z=D[0],B=D.pop();if(B!==z){D[0]=B;e:for(var ae=0,me=D.length,mr=me>>>1;ae<mr;){var be=2*(ae+1)-1,ze=D[be],Pt=be+1,Bn=D[Pt];if(0>i(ze,B))Pt<me&&0>i(Bn,ze)?(D[ae]=Bn,D[Pt]=B,ae=Pt):(D[ae]=ze,D[be]=B,ae=be);else if(Pt<me&&0>i(Bn,B))D[ae]=Bn,D[Pt]=B,ae=Pt;else break e}}return z}function i(D,z){var B=D.sortIndex-z.sortIndex;return B!==0?B:D.id-z.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,l=o.now();t.unstable_now=function(){return o.now()-l}}var a=[],u=[],f=1,d=null,h=3,y=!1,_=!1,w=!1,E=typeof setTimeout=="function"?setTimeout:null,g=typeof clearTimeout=="function"?clearTimeout:null,p=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function m(D){for(var z=n(u);z!==null;){if(z.callback===null)r(u);else if(z.startTime<=D)r(u),z.sortIndex=z.expirationTime,e(a,z);else break;z=n(u)}}function S(D){if(w=!1,m(D),!_)if(n(a)!==null)_=!0,pt(R);else{var z=n(u);z!==null&&mi(S,z.startTime-D)}}function R(D,z){_=!1,w&&(w=!1,g(k),k=-1),y=!0;var B=h;try{for(m(z),d=n(a);d!==null&&(!(d.expirationTime>z)||D&&!N());){var ae=d.callback;if(typeof ae=="function"){d.callback=null,h=d.priorityLevel;var me=ae(d.expirationTime<=z);z=t.unstable_now(),typeof me=="function"?d.callback=me:d===n(a)&&r(a),m(z)}else r(a);d=n(a)}if(d!==null)var mr=!0;else{var be=n(u);be!==null&&mi(S,be.startTime-z),mr=!1}return mr}finally{d=null,h=B,y=!1}}var I=!1,A=null,k=-1,F=5,j=-1;function N(){return!(t.unstable_now()-j<F)}function Q(){if(A!==null){var D=t.unstable_now();j=D;var z=!0;try{z=A(!0,D)}finally{z?Se():(I=!1,A=null)}}else I=!1}var Se;if(typeof p=="function")Se=function(){p(Q)};else if(typeof MessageChannel<"u"){var ye=new MessageChannel,zn=ye.port2;ye.port1.onmessage=Q,Se=function(){zn.postMessage(null)}}else Se=function(){E(Q,0)};function pt(D){A=D,I||(I=!0,Se())}function mi(D,z){k=E(function(){D(t.unstable_now())},z)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(D){D.callback=null},t.unstable_continueExecution=function(){_||y||(_=!0,pt(R))},t.unstable_forceFrameRate=function(D){0>D||125<D?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):F=0<D?Math.floor(1e3/D):5},t.unstable_getCurrentPriorityLevel=function(){return h},t.unstable_getFirstCallbackNode=function(){return n(a)},t.unstable_next=function(D){switch(h){case 1:case 2:case 3:var z=3;break;default:z=h}var B=h;h=z;try{return D()}finally{h=B}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(D,z){switch(D){case 1:case 2:case 3:case 4:case 5:break;default:D=3}var B=h;h=D;try{return z()}finally{h=B}},t.unstable_scheduleCallback=function(D,z,B){var ae=t.unstable_now();switch(typeof B=="object"&&B!==null?(B=B.delay,B=typeof B=="number"&&0<B?ae+B:ae):B=ae,D){case 1:var me=-1;break;case 2:me=250;break;case 5:me=1073741823;break;case 4:me=1e4;break;default:me=5e3}return me=B+me,D={id:f++,callback:z,priorityLevel:D,startTime:B,expirationTime:me,sortIndex:-1},B>ae?(D.sortIndex=B,e(u,D),n(a)===null&&D===n(u)&&(w?(g(k),k=-1):w=!0,mi(S,B-ae))):(D.sortIndex=me,e(a,D),_||y||(_=!0,pt(R))),D},t.unstable_shouldYield=N,t.unstable_wrapCallback=function(D){var z=h;return function(){var B=h;h=z;try{return D.apply(this,arguments)}finally{h=B}}}})(Ip);kp.exports=Ip;var cv=kp.exports;/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let al;function rx(t){T(!al,"__referenceConstructor has already been defined"),al=t}function ix(){return T(al,"Reference.ts has not been loaded"),al}let sx=1;class zf{constructor(e){this.listenProvider_=e,this.syncPointTree_=new se(null),this.pendingWriteTree_=bE(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function F_(t,e,n,r,i){return SE(t.pendingWriteTree_,e,n,r,i),i?Ns(t,new ur(S_(),e,n)):[]}function qn(t,e,n=!1){const r=EE(t.pendingWriteTree_,e);if(xE(t.pendingWriteTree_,e)){let s=new se(null);return r.snap!=null?s=s.set(X(),!0):Ze(r.children,o=>{s=s.set(new te(o),!0)}),Ns(t,new rl(r.path,s,n))}else return[]}function jl(t,e,n){return Ns(t,new ur(ld(),e,n))}function ox(t,e,n){const r=se.fromObject(n);return Ns(t,new vs(ld(),e,r))}function lx(t,e){return Ns(t,new ys(ld(),e))}function ax(t,e,n){const r=gd(t,n);if(r){const i=md(r),s=i.path,o=i.queryId,l=Ke(s,e),a=new ys(ad(o),l);return _d(t,s,a)}else return[]}function Vu(t,e,n,r,i=!1){const s=e._path,o=t.syncPointTree_.get(s);let l=[];if(o&&(e._queryIdentifier==="default"||O_(o,e))){const a=nx(o,e,n,r);ZE(o)&&(t.syncPointTree_=t.syncPointTree_.remove(s));const u=a.removed;if(l=a.events,!i){const f=u.findIndex(h=>h._queryParams.loadsAllData())!==-1,d=t.syncPointTree_.findOnPath(s,(h,y)=>bn(y));if(f&&!d){const h=t.syncPointTree_.subtree(s);if(!h.isEmpty()){const y=dx(h);for(let _=0;_<y.length;++_){const w=y[_],E=w.query,g=j_(t,w);t.listenProvider_.startListening(Ki(E),ul(t,E),g.hashFn,g.onComplete)}}}!d&&u.length>0&&!r&&(f?t.listenProvider_.stopListening(Ki(e),null):u.forEach(h=>{const y=t.queryToTagMap.get(zl(h));t.listenProvider_.stopListening(Ki(h),y)}))}hx(t,u)}return l}function ux(t,e,n,r){const i=gd(t,r);if(i!=null){const s=md(i),o=s.path,l=s.queryId,a=Ke(o,e),u=new ur(ad(l),a,n);return _d(t,o,u)}else return[]}function cx(t,e,n,r){const i=gd(t,r);if(i){const s=md(i),o=s.path,l=s.queryId,a=Ke(o,e),u=se.fromObject(n),f=new vs(ad(l),a,u);return _d(t,o,f)}else return[]}function Bf(t,e,n,r=!1){const i=e._path;let s=null,o=!1;t.syncPointTree_.foreachOnPath(i,(h,y)=>{const _=Ke(h,i);s=s||Hr(y,_),o=o||bn(y)});let l=t.syncPointTree_.get(i);l?(o=o||bn(l),s=s||Hr(l,X())):(l=new qE,t.syncPointTree_=t.syncPointTree_.set(i,l));let a;s!=null?a=!0:(a=!1,s=L.EMPTY_NODE,t.syncPointTree_.subtree(i).foreachChild((y,_)=>{const w=Hr(_,X());w&&(s=s.updateImmediateChild(y,w))}));const u=O_(l,e);if(!u&&!e._queryParams.loadsAllData()){const h=zl(e);T(!t.queryToTagMap.has(h),"View does not exist, but we have a tag");const y=fx();t.queryToTagMap.set(h,y),t.tagToQueryMap.set(y,h)}const f=ud(t.pendingWriteTree_,i);let d=tx(l,e,n,f,s,a);if(!u&&!o&&!r){const h=b_(l,e);d=d.concat(px(t,e,h))}return d}function pd(t,e,n){const i=t.pendingWriteTree_,s=t.syncPointTree_.findOnPath(e,(o,l)=>{const a=Ke(o,e),u=Hr(l,a);if(u)return u});return I_(i,e,s,n,!0)}function Ns(t,e){return L_(e,t.syncPointTree_,null,ud(t.pendingWriteTree_,X()))}function L_(t,e,n,r){if(G(t.path))return M_(t,e,n,r);{const i=e.get(X());n==null&&i!=null&&(n=Hr(i,X()));let s=[];const o=H(t.path),l=t.operationForChild(o),a=e.children.get(o);if(a&&l){const u=n?n.getImmediateChild(o):null,f=T_(r,o);s=s.concat(L_(l,a,u,f))}return i&&(s=s.concat(fd(i,t,r,n))),s}}function M_(t,e,n,r){const i=e.get(X());n==null&&i!=null&&(n=Hr(i,X()));let s=[];return e.children.inorderTraversal((o,l)=>{const a=n?n.getImmediateChild(o):null,u=T_(r,o),f=t.operationForChild(o);f&&(s=s.concat(M_(f,l,a,u)))}),i&&(s=s.concat(fd(i,t,r,n))),s}function j_(t,e){const n=e.query,r=ul(t,n);return{hashFn:()=>(GE(e)||L.EMPTY_NODE).hash(),onComplete:i=>{if(i==="ok")return r?ax(t,n._path,r):lx(t,n._path);{const s=uS(i,n);return Vu(t,n,null,s)}}}}function ul(t,e){const n=zl(e);return t.queryToTagMap.get(n)}function zl(t){return t._path.toString()+"$"+t._queryIdentifier}function gd(t,e){return t.tagToQueryMap.get(e)}function md(t){const e=t.indexOf("$");return T(e!==-1&&e<t.length-1,"Bad queryKey."),{queryId:t.substr(e+1),path:new te(t.substr(0,e))}}function _d(t,e,n){const r=t.syncPointTree_.get(e);T(r,"Missing sync point for query tag that we're tracking");const i=ud(t.pendingWriteTree_,e);return fd(r,n,i,null)}function dx(t){return t.fold((e,n,r)=>{if(n&&bn(n))return[Ml(n)];{let i=[];return n&&(i=D_(n)),Ze(r,(s,o)=>{i=i.concat(o)}),i}})}function Ki(t){return t._queryParams.loadsAllData()&&!t._queryParams.isDefault()?new(ix())(t._repo,t._path):t}function hx(t,e){for(let n=0;n<e.length;++n){const r=e[n];if(!r._queryParams.loadsAllData()){const i=zl(r),s=t.queryToTagMap.get(i);t.queryToTagMap.delete(i),t.tagToQueryMap.delete(s)}}}function fx(){return sx++}function px(t,e,n){const r=e._path,i=ul(t,e),s=j_(t,n),o=t.listenProvider_.startListening(Ki(e),i,s.hashFn,s.onComplete),l=t.syncPointTree_.subtree(r);if(i)T(!bn(l.value),"If we're adding a query, it shouldn't be shadowed");else{const a=l.fold((u,f,d)=>{if(!G(u)&&f&&bn(f))return[Ml(f).query];{let h=[];return f&&(h=h.concat(D_(f).map(y=>y.query))),Ze(d,(y,_)=>{h=h.concat(_)}),h}});for(let u=0;u<a.length;++u){const f=a[u];t.listenProvider_.stopListening(Ki(f),ul(t,f))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
