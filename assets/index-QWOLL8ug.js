 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(D,z){var B=D.length;D.push(z);e:for(;0<B;){var le=B-1>>>1,Z=D[le];if(0<i(Z,z))D[le]=z,D[B]=Z,B=le;else break e}}function n(D){return D.length===0?null:D[0]}function r(D){if(D.length===0)return null;var z=D[0],B=D.pop();if(B!==z){D[0]=B;e:for(var le=0,Z=D.length,Ne=Z>>>1;le<Ne;){var It=2*(le+1)-1,fr=D[It],U=It+1,tn=D[U];if(0>i(fr,B))U<Z&&0>i(tn,fr)?(D[le]=tn,D[U]=B,le=U):(D[le]=fr,D[It]=B,le=It);else if(U<Z&&0>i(tn,B))D[le]=tn,D[U]=B,le=U;else break e}}return z}function i(D,z){var B=D.sortIndex-z.sortIndex;return B!==0?B:D.id-z.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,l=o.now();t.unstable_now=function(){return o.now()-l}}var a=[],u=[],f=1,h=null,d=3,y=!1,g=!1,C=!1,N=typeof setTimeout=="function"?setTimeout:null,m=typeof clearTimeout=="function"?clearTimeout:null,p=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function _(D){for(var z=n(u);z!==null;){if(z.callback===null)r(u);else if(z.startTime<=D)r(u),z.sortIndex=z.expirationTime,e(a,z);else break;z=n(u)}}function S(D){if(C=!1,_(D),!g)if(n(a)!==null)g=!0,dt(A);else{var z=n(u);z!==null&&pi(S,z.startTime-D)}}function A(D,z){g=!1,C&&(C=!1,m(x),x=-1),y=!0;var B=d;try{for(_(z),h=n(a);h!==null&&(!(h.expirationTime>z)||D&&!P());){var le=h.callback;if(typeof le=="function"){h.callback=null,d=h.priorityLevel;var Z=le(h.expirationTime<=z);z=t.unstable_now(),typeof Z=="function"?h.callback=Z:h===n(a)&&r(a),_(z)}else r(a);h=n(a)}if(h!==null)var Ne=!0;else{var It=n(u);It!==null&&pi(S,It.startTime-z),Ne=!1}return Ne}finally{h=null,d=B,y=!1}}var T=!1,R=null,x=-1,L=5,j=-1;function P(){return!(t.unstable_now()-j<L)}function G(){if(R!==null){var D=t.unstable_now();j=D;var z=!0;try{z=R(!0,D)}finally{z?we():(T=!1,R=null)}}else T=!1}var we;if(typeof p=="function")we=function(){p(G)};else if(typeof MessageChannel<"u"){var me=new MessageChannel,Mn=me.port2;me.port1.onmessage=G,we=function(){Mn.postMessage(null)}}else we=function(){N(G,0)};function dt(D){R=D,T||(T=!0,we())}function pi(D,z){x=N(function(){D(t.unstable_now())},z)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(D){D.callback=null},t.unstable_continueExecution=function(){g||y||(g=!0,dt(A))},t.unstable_forceFrameRate=function(D){0>D||125<D?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):L=0<D?Math.floor(1e3/D):5},t.unstable_getCurrentPriorityLevel=function(){return d},t.unstable_getFirstCallbackNode=function(){return n(a)},t.unstable_next=function(D){switch(d){case 1:case 2:case 3:var z=3;break;default:z=d}var B=d;d=z;try{return D()}finally{d=B}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(D,z){switch(D){case 1:case 2:case 3:case 4:case 5:break;default:D=3}var B=d;d=D;try{return z()}finally{d=B}},t.unstable_scheduleCallback=function(D,z,B){var le=t.unstable_now();switch(typeof B=="object"&&B!==null?(B=B.delay,B=typeof B=="number"&&0<B?le+B:le):B=le,D){case 1:var Z=-1;break;case 2:Z=250;break;case 5:Z=1073741823;break;case 4:Z=1e4;break;default:Z=5e3}return Z=B+Z,D={id:f++,callback:z,priorityLevel:D,startTime:B,expirationTime:Z,sortIndex:-1},B>le?(D.sortIndex=B,e(u,D),n(a)===null&&D===n(u)&&(C?(m(x),x=-1):C=!0,pi(S,B-le))):(D.sortIndex=Z,e(a,D),g||y||(g=!0,dt(A))),D},t.unstable_shouldYield=P,t.unstable_wrapCallback=function(D){var z=d;return function(){var B=d;d=z;try{return D.apply(this,arguments)}finally{d=B}}}})(Ep);Sp.exports=Ep;var lv=Sp.exports;/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const JS=Math.log(2);class ZS{constructor(e){const n=s=>parseInt(Math.log(s)/JS,10),r=s=>parseInt(Array(s+1).join("1"),2);this.count=n(e+1),this.current_=this.count-1;const i=r(this.count);this.bits_=e+1&i}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const el=function(t,e,n,r){t.sort(e);const i=function(a,u){const f=u-a;let h,d;if(f===0)return null;if(f===1)return h=t[a],d=n?n(h):h,new Ee(d,h.node,Ee.BLACK,null,null);{const y=parseInt(f/2,10)+a,g=i(a,y),C=i(y+1,u);return h=t[y],d=n?n(h):h,new Ee(d,h.node,Ee.BLACK,g,C)}},s=function(a){let u=null,f=null,h=t.length;const d=function(g,C){const N=h-g,m=h;h-=g;const p=i(N+1,m),_=t[N],S=n?n(_):_;y(new Ee(S,_.node,C,null,p))},y=function(g){u?(u.left=g,u=g):(f=g,u=g)};for(let g=0;g<a.count;++g){const C=a.nextBitIsOne(),N=Math.pow(2,a.count-(g+1));C?d(N,Ee.BLACK):(d(N,Ee.BLACK),d(N,Ee.RED))}return f},o=new ZS(t.length),l=s(o);return new Ve(r||e,l)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rl{constructor(e,n,r){this.path=e,this.affectedTree=n,this.revert=r,this.type=vt.ACK_USER_WRITE,this.source=v_()}operationForChild(e){if($(this.path)){if(this.affectedTree.value!=null)return k(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const n=this.affectedTree.subtree(new ee(e));return new rl(Y(),n,this.revert)}}else return k(W(this.path)===e,"operationForChild called for unrelated child."),new rl(te(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let al;function ex(t){k(!al,"__referenceConstructor has already been defined"),al=t}function tx(){return k(al,"Reference.ts has not been loaded"),al}let nx=1;class Lf{constructor(e){this.listenProvider_=e,this.syncPointTree_=new ie(null),this.pendingWriteTree_=NE(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function D_(t,e,n,r,i){return vE(t.pendingWriteTree_,e,n,r,i),i?Ps(t,new or(v_(),e,n)):[]}function Kn(t,e,n=!1){const r=wE(t.pendingWriteTree_,e);if(CE(t.pendingWriteTree_,e)){let s=new ie(null);return r.snap!=null?s=s.set(Y(),!0):qe(r.children,o=>{s=s.set(new ee(o),!0)}),Ps(t,new rl(r.path,s,n))}else return[]}function jl(t,e,n){return Ps(t,new or(id(),e,n))}function rx(t,e,n){const r=ie.fromObject(n);return Ps(t,new vs(id(),e,r))}function ix(t,e){return Ps(t,new ys(id(),e))}function sx(t,e,n){const r=hd(t,n);if(r){const i=fd(r),s=i.path,o=i.queryId,l=$e(s,e),a=new ys(sd(o),l);return pd(t,s,a)}else return[]}function Wu(t,e,n,r,i=!1){const s=e._path,o=t.syncPointTree_.get(s);let l=[];if(o&&(e._queryIdentifier==="default"||P_(o,e))){const a=ZE(o,e,n,r);qE(o)&&(t.syncPointTree_=t.syncPointTree_.remove(s));const u=a.removed;if(l=a.events,!i){const f=u.findIndex(d=>d._queryParams.loadsAllData())!==-1,h=t.syncPointTree_.findOnPath(s,(d,y)=>Pn(y));if(f&&!h){const d=t.syncPointTree_.subtree(s);if(!d.isEmpty()){const y=ax(d);for(let g=0;g<y.length;++g){const C=y[g],N=C.query,m=L_(t,C);t.listenProvider_.startListening(Ki(N),ul(t,N),m.hashFn,m.onComplete)}}}!h&&u.length>0&&!r&&(f?t.listenProvider_.stopListening(Ki(e),null):u.forEach(d=>{const y=t.queryToTagMap.get(zl(d));t.listenProvider_.stopListening(Ki(d),y)}))}ux(t,u)}return l}function ox(t,e,n,r){const i=hd(t,r);if(i!=null){const s=fd(i),o=s.path,l=s.queryId,a=$e(o,e),u=new or(sd(l),a,n);return pd(t,o,u)}else return[]}function lx(t,e,n,r){const i=hd(t,r);if(i){const s=fd(i),o=s.path,l=s.queryId,a=$e(o,e),u=ie.fromObject(n),f=new vs(sd(l),a,u);return pd(t,o,f)}else return[]}function Ff(t,e,n,r=!1){const i=e._path;let s=null,o=!1;t.syncPointTree_.foreachOnPath(i,(d,y)=>{const g=$e(d,i);s=s||Br(y,g),o=o||Pn(y)});let l=t.syncPointTree_.get(i);l?(o=o||Pn(l),s=s||Br(l,Y())):(l=new KE,t.syncPointTree_=t.syncPointTree_.set(i,l));let a;s!=null?a=!0:(a=!1,s=F.EMPTY_NODE,t.syncPointTree_.subtree(i).foreachChild((y,g)=>{const C=Br(g,Y());C&&(s=s.updateImmediateChild(y,C))}));const u=P_(l,e);if(!u&&!e._queryParams.loadsAllData()){const d=zl(e);k(!t.queryToTagMap.has(d),"View does not exist, but we have a tag");const y=cx();t.queryToTagMap.set(d,y),t.tagToQueryMap.set(y,d)}const f=od(t.pendingWriteTree_,i);let h=JE(l,e,n,f,s,a);if(!u&&!o&&!r){const d=N_(l,e);h=h.concat(dx(t,e,d))}return h}function dd(t,e,n){const i=t.pendingWriteTree_,s=t.syncPointTree_.findOnPath(e,(o,l)=>{const a=$e(o,e),u=Br(l,a);if(u)return u});return E_(i,e,s,n,!0)}function Ps(t,e){return O_(e,t.syncPointTree_,null,od(t.pendingWriteTree_,Y()))}function O_(t,e,n,r){if($(t.path))return b_(t,e,n,r);{const i=e.get(Y());n==null&&i!=null&&(n=Br(i,Y()));let s=[];const o=W(t.path),l=t.operationForChild(o),a=e.children.get(o);if(a&&l){const u=n?n.getImmediateChild(o):null,f=x_(r,o);s=s.concat(O_(l,a,u,f))}return i&&(s=s.concat(cd(i,t,r,n))),s}}function b_(t,e,n,r){const i=e.get(Y());n==null&&i!=null&&(n=Br(i,Y()));let s=[];return e.children.inorderTraversal((o,l)=>{const a=n?n.getImmediateChild(o):null,u=x_(r,o),f=t.operationForChild(o);f&&(s=s.concat(b_(f,l,a,u)))}),i&&(s=s.concat(cd(i,t,r,n))),s}function L_(t,e){const n=e.query,r=ul(t,n);return{hashFn:()=>(HE(e)||F.EMPTY_NODE).hash(),onComplete:i=>{if(i==="ok")return r?sx(t,n._path,r):ix(t,n._path);{const s=oS(i,n);return Wu(t,n,null,s)}}}}function ul(t,e){const n=zl(e);return t.queryToTagMap.get(n)}function zl(t){return t._path.toString()+"$"+t._queryIdentifier}function hd(t,e){return t.tagToQueryMap.get(e)}function fd(t){const e=t.indexOf("$");return k(e!==-1&&e<t.length-1,"Bad queryKey."),{queryId:t.substr(e+1),path:new ee(t.substr(0,e))}}function pd(t,e,n){const r=t.syncPointTree_.get(e);k(r,"Missing sync point for query tag that we're tracking");const i=od(t.pendingWriteTree_,e);return cd(r,n,i,null)}function ax(t){return t.fold((e,n,r)=>{if(n&&Pn(n))return[Ml(n)];{let i=[];return n&&(i=A_(n)),qe(r,(s,o)=>{i=i.concat(o)}),i}})}function Ki(t){return t._queryParams.loadsAllData()&&!t._queryParams.isDefault()?new(tx())(t._repo,t._path):t}function ux(t,e){for(let n=0;n<e.length;++n){const r=e[n];if(!r._queryParams.loadsAllData()){const i=zl(r),s=t.queryToTagMap.get(i);t.queryToTagMap.delete(i),t.tagToQueryMap.delete(s)}}}function cx(){return nx++}function dx(t,e,n){const r=e._path,i=ul(t,e),s=L_(t,n),o=t.listenProvider_.startListening(Ki(e),i,s.hashFn,s.onComplete),l=t.syncPointTree_.subtree(r);if(i)k(!Pn(l.value),"If we're adding a query, it shouldn't be shadowed");else{const a=l.fold((u,f,h)=>{if(!$(u)&&f&&Pn(f))return[Ml(f).query];{let d=[];return f&&(d=d.concat(A_(f).map(y=>y.query))),qe(h,(y,g)=>{d=d.concat(g)}),d}});for(let u=0;u<a.length;++u){const f=a[u];t.listenProvider_.stopListening(Ki(f),ul(t,f))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function b1(t,e){const n=Qc(t,"auth");if(n.isInitialized()){const i=n.getImmediate(),s=n.getOptions();if(rr(s,e??{}))return i;Ot(i,"already-initialized")}return n.initialize({options:e})}function L1(t,e){const n=(e==null?void 0:e.persistence)||[],r=(Array.isArray(n)?n:[n]).map(Wt);e!=null&&e.errorMap&&t._updateErrorMap(e.errorMap),t._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function F1(t,e,n){const r=Hl(t);M(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const i=!1,s=fy(e),{host:o,port:l}=M1(e),a=l===null?"":`:${l}`,u={url:`${s}//${o}${a}/`},f=Object.freeze({host:o,port:l,protocol:s.replace(":",""),options:Object.freeze({disableWarnings:i})});if(!r._canInitEmulator){M(r.config.emulator&&r.emulatorConfig,r,"emulator-config-failed"),M(rr(u,r.config.emulator)&&rr(f,r.emulatorConfig),r,"emulator-config-failed");return}r.config.emulator=u,r.emulatorConfig=f,r.settings.appVerificationDisabledForTesting=!0,Ts(o)?Pm(`${s}//${o}${a}`):j1()}function fy(t){const e=t.indexOf(":");return e<0?"":t.substr(0,e+1)}function M1(t){const e=fy(t),n=/(\/\/)?([^?#/]+)/.exec(t.substr(e.length));if(!n)return{host:"",port:null};const r=n[2].split("@").pop()||"",i=/^(\[[^\]]+\])(:|$)/.exec(r);if(i){const s=i[1];return{host:s,port:Qf(r.substr(s.length+1))}}else{const[s,o]=r.split(":");return{host:s,port:Qf(o)}}}function Qf(t){if(!t)return null;const e=Number(t);return isNaN(e)?null:e}function j1(){function t(){const e=document.createElement("p"),n=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",n.position="fixed",n.width="100%",n.backgroundColor="#ffffff",n.border=".1em solid #000000",n.color="#b50000",n.bottom="0px",n.left="0px",n.margin="0px",n.zIndex="10000",n.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",t):t())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
